package com.wirelust.as3zlib
{
   internal final class InfCodes
   {
      ...
      public function inflate_fast(param1:int, param2:int, param3:Array, param4:int, param5:Array, param6:int, param7:InfBlocks, param8:ZStream) : int
      {
         ...
         _loc18_ = _loc17_ < param7.read ? param7.read - _loc17_ - 1 : param7.end - _loc17_;
         ...
         while(true)
         {
            if(_loc14_ >= 20)
            {
               ...
               if(_loc12_ == 0)
               {
                  ...
                  param7.window[_loc17_++] = _loc10_[_loc24_ + 2];
                  _loc18_--;
               }
               else
               {
                  do
                  {
                     ...
                     if((_loc12_ & 0x10) != 0)
                     {
                        ...
                        {
                           _loc16_--;
                           _loc13_ |= (param8.next_in[_loc15_++] & 0xFF) << _loc14_;
                           _loc14_ += 8;
                        }
                        ...
                        do
                        {
                           ...
                           if((_loc12_ & 0x10) != 0)
                           {
                              ...
                              if(_loc17_ >= _loc22_)
                              {
                                 ...
                                 {
                                    param7.window[_loc17_++] = param7.window[_loc23_++];
                                    param7.window[_loc17_++] = param7.window[_loc23_++];
                                    _loc21_ -= 2;
                                 }
                                 else
                           ...
                           if((_loc12_ & 0x40) != 0)
                           {
                              ...
                              _loc21_ = _loc14_ >> 3 < _loc21_ ? _loc14_ >> 3 : _loc21_;
                              _loc16_ += _loc21_;
                              _loc15_ -= _loc21_;
                              _loc14_ -= _loc21_ << 3;
                              param7.bitb = _loc13_;
      ...
      internal function proc(param1:InfBlocks, param2:ZStream, param3:int) : int
      {
         ...
         _loc13_ = _loc12_ < param1.read ? param1.read - _loc12_ - 1 : param1.end - _loc12_;
         while(true)
         {
            switch(this.mode)
            {
               case START:
                  if(_loc13_ >= 258 && _loc11_ >= 10)
                  {
                     ...
                     if(param3 != Z_OK)
                     {
                        this.mode = param3 == Z_STREAM_END ? WASH : BADCODE;
                        continue;
                     }
                  }
               ...
               case LEN:
                  ...
                  while(_loc9_ < _loc4_)
                  {
                     ...
                     param3 = Z_OK;
                     _loc11_--;
                     _loc8_ |= (param2.next_in[_loc10_++] & 0xFF) << _loc9_;
                     _loc9_ += 8;
                  }
                  ...
                  else if((_loc7_ & 0x10) != 0)
                  {
                     this.getBits = _loc7_ & 0x0F;
                     this.len = this.tree[_loc6_ + 2];
                     this.mode = LENEXT;
                  }
                  else if((_loc7_ & 0x40) == 0)
                  {
                     this.need = _loc7_;
               ...
               case COPY:
                  ...
                  while(this.len != 0)
                  {
                     ...
                     param1.window[_loc12_++] = param1.window[_loc14_++];
                     _loc13_--;
               ...
               case LIT:
                  ...
                  param3 = Z_OK;
                  param1.window[_loc12_++] = this.lit;
                  _loc13_--;
                  this.mode = START;
                  break;
               case WASH:
