package com.wirelust.as3zlib
{
   ...
   public final class Inflate
   {
      ...
      public function inflateReset(param1:ZStream) : int
      {
         ...
         param1.msg = null;
         param1.istate.mode = param1.istate.nowrap != 0 ? BLOCKS : METHOD;
      ...
      public function inflate(param1:ZStream, param2:int) : int
      {
         ...
         param2 = param2 == Z_FINISH ? Z_BUF_ERROR : Z_OK;
         _loc3_ = Z_BUF_ERROR;
         while(true)
         {
            switch(param1.istate.mode)
            {
               case METHOD:
                  ...
                  --param1.avail_in;
                  ++param1.total_in;
                  if(((param1.istate.method = param1.next_in[param1.next_in_index++]) & 0x0F) != Z_DEFLATED)
                  {
               ...
               case FLAG:
                  ...
                  --param1.avail_in;
                  ++param1.total_in;
                  _loc4_ = param1.next_in[param1.next_in_index++] & 0xFF;
               ...
               case DICT4:
                  ...
                  --param1.avail_in;
                  ++param1.total_in;
                  param1.istate.need = (param1.next_in[param1.next_in_index++] & 0xFF) << 24 & 0xFF000000;
               ...
               case DICT3:
                  ...
                  --param1.avail_in;
                  ++param1.total_in;
                  param1.istate.need += (param1.next_in[param1.next_in_index++] & 0xFF) << 16 & 0xFF0000;
               ...
               case DICT2:
                  ...
                  --param1.avail_in;
                  ++param1.total_in;
                  param1.istate.need += (param1.next_in[param1.next_in_index++] & 0xFF) << 8 & 0xFF00;
               ...
               case CHECK1:
                  ...
                  --param1.avail_in;
                  ++param1.total_in;
                  param1.istate.need += param1.next_in[param1.next_in_index++] & 0xFF;
