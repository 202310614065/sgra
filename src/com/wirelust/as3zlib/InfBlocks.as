            ...
            switch(this.mode)
            {
               ...
               case LENS:
                  while(_loc5_ < 32)
                  {
                     ...
                     param2 = Z_OK;
                     _loc7_--;
                     _loc4_ |= (param1.next_in[_loc6_++] & 0xFF) << _loc5_;
                     _loc5_ += 8;
                  }
                  if((~_loc4_ >>> 16 & 0xFFFF) != (_loc4_ & 0xFFFF))
                  {
                     this.mode = BAD;
               ...
               case TABLE:
                  ...
                  this.table = _loc3_ = _loc4_ & 0x3FFF;
                  if((_loc3_ & 0x1F) > 29 || (_loc3_ >> 5 & 0x1F) > 29)
                  {
                     this.mode = BAD;
                  ...
                  _loc3_ = 258 + (_loc3_ & 0x1F) + (_loc3_ >> 5 & 0x1F);
               ...
               case DTREE:
                  ...
                  {
                     _loc3_ = this.table;
                     if(this.index >= 258 + (_loc3_ & 0x1F) + (_loc3_ >> 5 & 0x1F))
                     {
                        break;
                     }
                     ...
                     if(_loc17_ < 16)
                     {
                        _loc4_ >>>= _loc3_;
                        _loc5_ -= _loc3_;
                        this.blens[this.index++] = _loc17_;
                     }
                     else
                     {
                        _loc15_ = _loc17_ == 18 ? 7 : _loc17_ - 14;
                        _loc16_ = _loc17_ == 18 ? 11 : 3;
                        ...
                        _loc15_ = this.index;
                        _loc3_ = this.table;
                        if(_loc15_ + _loc16_ > 258 + (_loc3_ & 0x1F) + (_loc3_ >> 5 & 0x1F) || _loc17_ == 16 && _loc15_ < 1)
                        {
                           this.blens = null;
                           this.mode = BAD;
                        ...
                        _loc17_ = _loc17_ == 16 ? int(this.blens[_loc15_ - 1]) : 0;
                        do
                        {
                           this.blens[_loc15_++] = _loc17_;
                        }
                        while(--_loc16_ != 0);
                  ...
                  _loc11_[0] = 6;
                  _loc3_ = this.table;
                  _loc3_ = this.inftree.inflate_trees_dynamic(257 + (_loc3_ & 0x1F),1 + (_loc3_ >> 5 & 0x1F),this.blens,_loc10_,_loc11_,_loc12_,_loc13_,this.hufts,param1);
                  if(_loc3_ != Z_OK)
                  {
               ...
               case CODES:
                  ...
                  param1.next_in_index = _loc6_;
                  this.write = _loc8_;
                  param2 = int(this.codes.proc(this,param1,param2));
                  if(param2 != Z_STREAM_END)
                  {
                     return this.inflate_flush(param1,param2);
                  }
                  param2 = Z_OK;
