package consortion.view.selfConsortia
{
   ...
   public class Badge extends Sprite implements Disposeable, ITipedDisplay
   {
      ...
      {
         this._tipInfo = {};
         var _loc1_:BadgeInfo = BadgeInfoManager.instance.getBadgeInfoByID(this._badgeID);
         if(Boolean(_loc1_))
         {
            this._tipInfo.name = _loc1_.BadgeName;
            this._tipInfo.LimitLevel = _loc1_.LimitLevel;
            this._tipInfo.ValidDate = _loc1_.ValidDate;
