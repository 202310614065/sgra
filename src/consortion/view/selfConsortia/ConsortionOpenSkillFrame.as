package consortion.view.selfConsortia
{
   ...
   public class ConsortionOpenSkillFrame extends Frame
   {
      ...
      public function set info(param1:ConsortionSkillInfo) : void
      {
         ...
         this._richesTxt.text = LanguageMgr.GetTranslation("consortion.openSkillFrame.richesText" + param1.type);
         if(param1.type == 1)
         {
            this._richesTxt.x = 38;
            this._richesbg.x = 152;
            this._riches.x = 154;
         }
         if(this._isMetal)
         {
