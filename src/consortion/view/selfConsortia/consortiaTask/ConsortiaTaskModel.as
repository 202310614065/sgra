package consortion.view.selfConsortia.consortiaTask
{
   ...
   public class ConsortiaTaskModel extends EventDispatcher
   {
      ...
      private function __releaseTaskCallBack(param1:CrazyTankSocketEvent) : void
      {
         ...
         var _loc13_:ConsortiaTaskEvent = null;
         var _loc14_:int = 0;
         var _loc15_:int = 0;
         var _loc16_:int = 0;
         var _loc17_:int = 0;
         ...
         {
            this._taskStatus = _loc2_.readBoolean();
            if(!this._taskStatus)
            {
               this.taskInfo = null;
            }
         ...
         else if(_loc3_ == UPDATE_TASKINFO)
         {
            ...
            {
               this.taskInfo.updateItemData(_loc6_,_loc7_,_loc8_);
            }
         }
         else if(_loc3_ == RELEASE_TASK || _loc3_ == RESET_TASK)
         {
            ...
            while(_loc10_ < _loc9_)
            {
               ...
               this.taskInfo.addItemData(_loc11_,_loc12_);
               _loc10_++;
            }
         }
         else
         {
            if(_loc3_ == DELAY_TIME)
            {
               _loc13_ = new ConsortiaTaskEvent(ConsortiaTaskEvent.DELAY_TASK_TIME);
               _loc13_.value = _loc2_.readInt();
               dispatchEvent(_loc13_);
               PlayerManager.Instance.Self.consortiaInfo.Riches = _loc2_.readInt();
               return;
            }
            ...
            if(_loc14_ > 0)
            {
               ...
               this.taskInfo.contribution = _loc2_.readInt();
               ...
               this.taskInfo.level = _loc2_.readInt();
            }
            else if(_loc14_ == -1)
            {
               this.taskInfo = null;
