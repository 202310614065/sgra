package consortion.view.selfConsortia
{
   ...
   public class ConsortionSkillFrame extends Frame
   {
      ...
      private function initView() : void
      {
         ...
         this._manager.text = LanguageMgr.GetTranslation("consortion.skillShop.manager.Text");
      ...
      private function showContent(param1:int) : void
      {
         ...
         this._riches.text = param1 == 1 ? String(PlayerManager.Instance.Self.consortiaInfo.Riches) : (param1 == 2 ? String(PlayerManager.Instance.Self.Riches) : String(PlayerManager.Instance.Self.BandMoney));
         var _loc2_:int = 0;
         while(_loc2_ < ConsortionModel.SKILL_MAX_LEVEL)
         {
            _loc3_ = _loc2_ + 1 > PlayerManager.Instance.Self.consortiaInfo.BufferLevel ? false : true;
            _loc4_ = param1 == 3 ? true : false;
            _loc5_ = new ConsortionSkillItem(_loc2_ + 1,_loc3_,_loc4_);
            _loc6_ = param1 == 3 ? 2 : param1;
