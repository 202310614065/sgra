package consortion.view.selfConsortia
{
   ...
   public class MemberList extends Sprite implements Disposeable
   {
      ...
      public function __updataMemberHandler(param1:ConsortionEvent) : void
      {
         ...
         var _loc3_:int = int(this._list.vectorListModel.elements.length);
         var _loc4_:int = 0;
         while(_loc4_ < _loc3_)
         {
      ...
      private function sortOnItem(param1:String, param2:Boolean = false) : void
      {
         ...
         if(param1 == "Init")
         {
            ...
            {
               if(Boolean(this._list.vectorListModel.elements[_loc4_]) && this._list.vectorListModel.elements[_loc4_].ID == PlayerManager.Instance.Self.ID)
               {
         ...
         {
            this._list.vectorListModel.elements.sortOn(param1,2 | 1 | 0x10);
         }
         if(param2)
         {
