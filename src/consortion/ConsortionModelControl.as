package consortion
{
   ...
   public class ConsortionModelControl extends EventDispatcher
   {
            ...
            case 4:
               ...
               if(SharedManager.Instance.showCI)
               {
                  if(this.str != _loc18_)
                  {
                     ...
                     this._enterConfirm = AlertManager.Instance.simpleAlert(LanguageMgr.GetTranslation("tank.manager.PlayerManager.request"),_loc40_,LanguageMgr.GetTranslation("tank.manager.PlayerManager.sure"),LanguageMgr.GetTranslation("tank.manager.PlayerManager.refuse"),false,true,true,LayerManager.ALPHA_BLOCKGOUND,CacheConsts.ALERT_IN_FIGHT) as SimpleAlert;
      ...
      {
         var _loc3_:Vector.<ConsortiaAssetLevelOffer> = null;
         var _loc4_:int = 0;
         var _loc2_:Boolean = param1.pkg.readBoolean();
         if(_loc2_)
         {
            _loc3_ = new Vector.<ConsortiaAssetLevelOffer>();
            _loc4_ = 0;
            while(_loc4_ < 7)
            {
               _loc3_[_loc4_] = new ConsortiaAssetLevelOffer();
               if(_loc4_ < 5)
               {
                  _loc3_[_loc4_].Type = 1;
                  _loc3_[_loc4_].Level = _loc4_ + 1;
               }
               else if(_loc4_ == 5)
               {
                  _loc3_[_loc4_].Type = 2;
               }
               else
               {
                  _loc3_[_loc4_].Type = 3;
               }
               _loc4_++;
            }
            _loc3_[0].Riches = param1.pkg.readInt();
            _loc3_[1].Riches = param1.pkg.readInt();
            _loc3_[2].Riches = param1.pkg.readInt();
            _loc3_[3].Riches = param1.pkg.readInt();
            _loc3_[4].Riches = param1.pkg.readInt();
            _loc3_[5].Riches = param1.pkg.readInt();
            _loc3_[6].Riches = param1.pkg.readInt();
            ...
            this._model.useConditionList = _loc3_;
         }
      ...
      public function getConsortionList(param1:Function, param2:int = 1, param3:int = 6, param4:String = "", param5:int = -1, param6:int = -1, param7:int = -1, param8:int = -1) : void
      {
         ...
         var _loc10_:BaseLoader = LoadResourceManager.Instance.createLoader(PathManager.solveRequestPath("ConsortiaList.ashx"),BaseLoader.COMPRESS_REQUEST_LOADER,_loc9_);
      ...
      public function getApplyRecordList(param1:Function, param2:int = -1, param3:int = -1) : void
      {
         ...
         _loc4_["userLevel"] = -1;
         var _loc5_:BaseLoader = LoadResourceManager.Instance.createLoader(PathManager.solveRequestPath("ConsortiaApplyUsersList.ashx"),BaseLoader.REQUEST_LOADER,_loc4_);
      ...
      public function getInviteRecordList(param1:Function) : void
      {
         ...
         _loc2_["inviteID"] = -1;
         var _loc3_:BaseLoader = LoadResourceManager.Instance.createLoader(PathManager.solveRequestPath("ConsortiaInviteUsersList.ashx"),BaseLoader.REQUEST_LOADER,_loc2_);
      ...
      public function getConsortionMember(param1:Function = null) : void
      {
         ...
         else
         {
            ...
            _loc3_ = LoaderManager.Instance.creatLoader(PathManager.solveRequestPath("ConsortiaUsersList.ashx"),BaseLoader.COMPRESS_REQUEST_LOADER,_loc2_);
      ...
      public function getLevelUpInfo() : BaseLoader
      {
         ...
         var _loc2_:BaseLoader = LoadResourceManager.Instance.createLoader(PathManager.solveRequestPath("ConsortiaLevelList.xml"),BaseLoader.COMPRESS_REQUEST_LOADER,_loc1_);
      ...
      public function loadEventList(param1:Function, param2:int = -1) : void
      {
         ...
         var _loc4_:BaseLoader = LoadResourceManager.Instance.createLoader(PathManager.solveRequestPath("ConsortiaEventList.ashx"),BaseLoader.REQUEST_LOADER,_loc3_);
      ...
      public function loadUseConditionList(param1:Function, param2:int = -1) : void
      {
         ...
         _loc3_["level"] = -1;
         _loc3_["type"] = -1;
         var _loc4_:BaseLoader = LoadResourceManager.Instance.createLoader(PathManager.solveRequestPath("ConsortiaEquipControlList.ashx"),BaseLoader.REQUEST_LOADER,_loc3_);
      ...
      public function loadDutyList(param1:Function, param2:int = -1, param3:int = -1) : void
      {
         ...
         var _loc5_:BaseLoader = LoadResourceManager.Instance.createLoader(PathManager.solveRequestPath("ConsortiaDutyList.ashx"),BaseLoader.REQUEST_LOADER,_loc4_);
      ...
      public function loadPollList(param1:int) : void
      {
         ...
         var _loc3_:BaseLoader = LoadResourceManager.Instance.createLoader(PathManager.solveRequestPath("ConsortiaCandidateList.ashx"),BaseLoader.REQUEST_LOADER,_loc2_);
      ...
      {
         var _loc1_:BaseLoader = LoadResourceManager.Instance.createLoader(PathManager.solveRequestPath("ConsortiaBufferTemp.xml"),BaseLoader.COMPRESS_TEXT_LOADER);
      ...
      public function getPerRank() : void
      {
         ...
         var _loc2_:BaseLoader = LoadResourceManager.Instance.creatAndStartLoad(PathManager.solveRequestPath("ConsortiaWarPlayerRank.ashx"),BaseLoader.REQUEST_LOADER,_loc1_);
         _loc2_.analyzer = new PersonalRankAnalyze(this.perRankPayHander);
      }
      
      private function perRankPayHander(param1:PersonalRankAnalyze) : void
      {
         ConsortionModelControl.Instance.dispatchEvent(new ConsortionEvent(ConsortionEvent.PERSONER_RANK_LIST,param1.dataList));
      }
      
      public function getConsortionRank() : void
      {
         var _loc1_:BaseLoader = LoadResourceManager.Instance.creatAndStartLoad(PathManager.solveRequestPath("ConsortiaWarConsortiaRank.ashx"),BaseLoader.REQUEST_LOADER);
         _loc1_.analyzer = new ConsortiaAnalyze(this.ConsortiaRankPayHander);
      }
      
      private function ConsortiaRankPayHander(param1:ConsortiaAnalyze) : void
      {
         ConsortionModelControl.Instance.dispatchEvent(new ConsortionEvent(ConsortionEvent.CLUB_RANK_LIST,param1.dataList));
      }
      ...
      {
         var _loc1_:HelpFrame = ComponentFactory.Instance.creatComponentByStylename("consortion.rank.helpFrame");
         LayerManager.Instance.addToLayer(_loc1_,LayerManager.GAME_DYNAMIC_LAYER,true,LayerManager.BLCAK_BLOCKGOUND);
      }
      ...
      {
         this._bossConfigDataList = param1.dataList;
      }
      ...
      {
         var _loc4_:int = 0;
         var _loc3_:ConsortiaInfo = PlayerManager.Instance.Self.consortiaInfo;
         if(param2 == 0)
         {
            _loc4_ = _loc3_.Level + _loc3_.SmithLevel + _loc3_.ShopLevel + _loc3_.StoreLevel + _loc3_.BufferLevel;
         }
         else
         {
            _loc4_ = param2;
         }
         var _loc5_:int = 100001;
         var _loc6_:int = int(this._bossConfigDataList.length);
         var _loc7_:int = 0;
         while(_loc7_ < _loc6_)
         {
            if(_loc4_ < this._bossConfigDataList[_loc7_].level)
            {
               break;
            }
            if(param1 == 1)
            {
               _loc5_ = int(this._bossConfigDataList[_loc7_].callBossRich);
            }
            else
            {
               _loc5_ = int(this._bossConfigDataList[_loc7_].extendTimeRich);
            }
            _loc7_++;
         }
         return _loc5_;
      ...
      {
         return this._bossConfigDataList[param1 - 1].callBossRich;
      }
      
      public function getCanCallBossMaxLevel(param1:int = 0) : int
      {
         var _loc3_:int = 0;
         var _loc2_:ConsortiaInfo = PlayerManager.Instance.Self.consortiaInfo;
         if(param1 == 0)
         {
            _loc3_ = _loc2_.Level + _loc2_.SmithLevel + _loc2_.ShopLevel + _loc2_.StoreLevel + _loc2_.BufferLevel;
         }
         else
         {
            _loc3_ = param1;
         }
         var _loc4_:int = int(this._bossConfigDataList.length);
         var _loc5_:int = 1;
         var _loc6_:int = _loc4_ - 1;
         while(_loc6_ >= 0)
         {
            if(_loc3_ >= this._bossConfigDataList[_loc6_].level)
            {
               _loc5_ = _loc6_ + 1;
               break;
            }
      ...
      {
         return this._bossConfigDataList[param1 - 1].level;
      }
      
      private function bossOpenCloseHandler(param1:CrazyTankSocketEvent) : void
      {
         var _loc2_:PackageIn = param1.pkg;
         var _loc3_:int = _loc2_.readByte();
         if(_loc3_ == 0)
      ...
      {
         var _loc1_:ConsortiaBossFrame = null;
         if(PlayerManager.Instance.Self.ConsortiaID != 0)
         {
            _loc1_ = ComponentFactory.Instance.creatComponentByStylename("consortia.boss.frame");
            LayerManager.Instance.addToLayer(_loc1_,LayerManager.GAME_DYNAMIC_LAYER,true,LayerManager.BLCAK_BLOCKGOUND);
         }
      }
   }
