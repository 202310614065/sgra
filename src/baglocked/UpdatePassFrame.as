package baglocked
{
   ...
   public class UpdatePassFrame extends Frame
   {
      ...
      override public function dispose() : void
      {
         ...
         ObjectUtils.disposeObject(this._ddtbaglock);
         this._ddtbaglock = null;
         super.dispose();
      }
      ...
      override protected function init() : void
      {
         ...
         this._ddtbaglock = ComponentFactory.Instance.creatComponentByStylename("ddtbaglocked.BG2");
         addToContent(this._ddtbaglock);
