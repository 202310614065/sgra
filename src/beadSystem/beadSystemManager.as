package beadSystem
{
   ...
   public class beadSystemManager extends EventDispatcher
   {
      ...
      private function __onOpenPackage(param1:CrazyTankSocketEvent) : void
      {
         var _loc2_:PackageIn = param1.pkg as PackageIn;
         var _loc3_:int = _loc2_.readInt();
         dispatchEvent(new BeadEvent(BeadEvent.LIGHTBTN,_loc3_));
         BeadModel.beadRequestBtnIndex = _loc3_;
      }
      ...
      public function getBeadNameTextFormatStyle(param1:int) : String
      {
         ...
         switch(param1)
         {
            ...
            case 18:
            case 19:
               _loc2_ = "beadSystem.beadCell.name.tf5";
               break;
            default:
               _loc2_ = "beadSystem.beadCell.name.tf1";
         }
         return _loc2_;
      }
