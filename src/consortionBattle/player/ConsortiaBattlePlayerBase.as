package consortionBattle.player
{
   ...
   public class ConsortiaBattlePlayerBase extends SceneCharacterPlayerBase
   {
      ...
      {
         this._sceneCharacterLoaderHead = new ConsBatLoaderHeadOrBody(this._playerData,1);
      ...
      {
         this._sceneCharacterLoaderBody = new ConsBatLoaderHeadOrBody(this._playerData,2);
