package consortionBattle.view
{
   ...
   public class ConsBatInfoView extends Sprite implements Disposeable
   {
      ...
      private function initView() : void
      {
         ...
         this._winningStreakTxt = ComponentFactory.Instance.creatComponentByStylename("consortiaBattle.infoView.infoTxt3");
      ...
      private function refreshView(param1:Event = null) : void
      {
         ...
         var _loc3_:int = ConsortiaBattleManager.instance.curHp == -1 ? _loc2_ : ConsortiaBattleManager.instance.curHp;
