package consortionBattle.view
{
   ...
   public class ConsortiaBattleMapView extends Sprite implements Disposeable
   {
      ...
      {
         var _loc2_:ConsBatBeforeTimer = null;
      ...
      protected function initMap() : void
      {
         ...
         _loc3_ = _loc1_.getChildByName("mesh") as Sprite;
         var _loc4_:Sprite = _loc1_.getChildByName("bg") as Sprite;
         _loc5_ = _loc1_.getChildByName("bgSize") as Sprite;
      ...
      {
         var _loc3_:ConsortiaBattlePlayer = null;
         var _loc2_:int = (param1.data as ConsortiaBattlePlayerInfo).id;
         if(Boolean(this._characters[_loc2_]))
         {
            _loc3_ = this._characters[_loc2_] as ConsortiaBattlePlayer;
      ...
      {
         var _loc4_:ConsortiaBattlePlayer = null;
         var _loc2_:int = int(param1.data.id);
         var _loc3_:Array = param1.data.path;
         if(Boolean(this._characters[_loc2_]))
         {
            _loc4_ = this._characters[_loc2_] as ConsortiaBattlePlayer;
            _loc4_.walkPath = _loc3_;
      ...
      protected function BuildEntityDepth() : void
      {
         ...
         var _loc1_:int = this._articleLayer.numChildren;
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_ - 1)
         {
            _loc3_ = this._articleLayer.getChildAt(_loc2_);
            _loc4_ = this.getPointDepth(_loc3_.x,_loc3_.y);
            _loc6_ = Number.MAX_VALUE;
            _loc7_ = _loc2_ + 1;
            while(_loc7_ < _loc1_)
            {
               _loc8_ = this._articleLayer.getChildAt(_loc7_);
            ...
            if(_loc4_ > _loc6_)
            {
               this._articleLayer.swapChildrenAt(_loc2_,_loc5_);
            }
            _loc2_++;
         }
      }
