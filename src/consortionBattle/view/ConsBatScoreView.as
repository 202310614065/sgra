      ...
      private function updateScore(param1:ConsBatEvent) : void
      {
         ...
         if(_loc3_ == 1)
         {
            ...
            while(_loc5_ < _loc4_)
            {
               ...
               this._consortiaScoreList.push(_loc7_);
               _loc5_++;
            }
            ...
            while(_loc6_ < _loc4_)
            {
               this._consortiaScoreList[_loc6_].rank = _loc6_ + 1;
               _loc6_++;
            }
         }
         else
         {
            ...
            {
               _loc10_ = {};
               _loc10_.name = _loc2_.readUTF();
               _loc10_.rank = _loc2_.readInt();
               _loc10_.score = _loc2_.readInt();
               this._playerScoreList.push(_loc10_);
               _loc9_++;
            }
