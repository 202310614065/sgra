package church.player
{
   ...
   public class ChurchPlayer extends ChurchPlayerBase
   {
      ...
      private var _currentWalkStartPoint:Point = this._playerVO.playerPos;
      ...
      private function initialize() : void
      {
         ...
         if(this._isShowName)
         {
            ...
            if(this.playerVO.playerInfo.ID != ChurchManager.instance.currentRoom.brideID && this.playerVO.playerInfo.ID != ChurchManager.instance.currentRoom.groomID)
            {
            ...
            else if(this.playerVO.playerInfo.IsVIP)
            {
               this._vipName = VipController.instance.getVipNameTxt(-1,this.playerVO.playerInfo.typeVIP);
               this._vipName.textSize = 16;
               this._vipName.x = this._lblName.x;
