package church.view.weddingRoomList
{
   ...
   public class CalculateDate
   {
      ...
      public static function start(param1:Date) : Array
      {
         ...
         {
            _loc3_[0] = "<font COLOR=\'#FF0000\'>" + LanguageMgr.GetTranslation("church.weddingRoom.frame.firstDivorce.note") + "</font>";
      ...
      public static function needMoney(param1:Date) : int
      {
         ...
         if(_loc3_ >= 720 || PlayerManager.Instance.Self.isFirstDivorce == 0)
         {
            _loc4_ = 999;
         }
         else
