package church.view.weddingRoom
{
   ...
   public class WeddingRoomMenuView extends Sprite implements Disposeable
   {
      ...
      public function revertConfig() : void
      {
         ...
         this._menuShowName.setFrame(this._model.playerNameVisible ? 1 : 2);
         this._menuShowPao.setFrame(this._model.playerChatBallVisible ? 1 : 2);
         this._menuShowFire.setFrame(this._model.playerFireVisible ? 1 : 2);
      }
