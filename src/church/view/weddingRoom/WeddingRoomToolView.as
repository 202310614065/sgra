package church.view.weddingRoom
{
   ...
   public class WeddingRoomToolView extends Sprite implements Disposeable
   {
      ...
      private function isGuest() : Boolean
      {
         ...
         var _loc2_:int = int(_loc1_.indexOf(PlayerManager.Instance.Self.NickName));
      ...
      public function giftView() : void
      {
         ...
         if(PlayerManager.Instance.Self.Money < LEAST_GIFT_MONEY)
         {
            ...
            _loc1_.msg = LanguageMgr.GetTranslation("church.churchScene.SceneControler.startWedding.Money",LEAST_GIFT_MONEY);
      ...
      {
         var _loc1_:BaseAlerFrame = AlertManager.Instance.simpleAlert(LanguageMgr.GetTranslation("AlertDialog.Info"),LanguageMgr.GetTranslation("church.weddingRoom.WeddingRoomController.continuationMoney",WeddingRoomCreateView.createRoomMoney[ChurchManager.instance.currentRoom.roomType]),LanguageMgr.GetTranslation("0K"),LanguageMgr.GetTranslation("cancel"),false,false,false,LayerManager.ALPHA_BLOCKGOUND);
         _loc1_.mouseEnabled = false;
         _loc1_.addEventListener(FrameEvent.RESPONSE,this.__continuationResponse);
      }
      
      private function __continuationResponse(param1:FrameEvent) : void
      {
         var _loc2_:BaseAlerFrame = param1.currentTarget as BaseAlerFrame;
         _loc2_.removeEventListener(FrameEvent.RESPONSE,this.__continuationResponse);
         if((param1.responseCode == FrameEvent.ENTER_CLICK || param1.responseCode == FrameEvent.SUBMIT_CLICK) && this.checkMoney() && Boolean(ChurchManager.instance.currentRoom))
         {
            this._controller.roomContinuation(2);
         }
      ...
      {
         if(PlayerManager.Instance.Self.Money < WeddingRoomCreateView.createRoomMoney[ChurchManager.instance.currentRoom.roomType])
         {
