package church.controller
{
   ...
   public class ChurchRoomListController extends BaseStateView
   {
      ...
      public function createRoom(param1:ChurchRoomInfo) : void
      {
         ...
         SocketManager.Instance.out.sendCreateRoom(param1.roomName,Boolean(param1.password) ? param1.password : "",param1.mapID,param1.valideTimes,param1.canInvite,param1.discription,param1.roomType);
      }
      ...
      {
         var _loc1_:ChurchRoomInfo = null;
         var _loc2_:WeddingRoomEnterInputPasswordView = null;
         if(MailManager.Instance.linkChurchRoomId != -1)
         {
            this.changeViewState(ChurchMainView.ROOM_LIST);
            _loc1_ = new ChurchRoomInfo();
            _loc1_.id = MailManager.Instance.linkChurchRoomId;
            _loc2_ = ComponentFactory.Instance.creat("church.main.weddingRoomList.WeddingRoomEnterInputPasswordView");
            _loc2_.churchRoomInfo = _loc1_;
            _loc2_.submitButtonEnable = false;
            _loc2_.show();
