   ...
   public class AuctionBuyView extends Sprite implements Disposeable
   {
      ...
      private function __selectRightStrip(param1:AuctionHouseEvent) : void
      {
         ...
         if(Boolean(_loc2_))
         {
            ...
            this._mouthful_btnR.enable = this._mouthful_btn.enable = _loc2_.Mouthful == 0 ? false : true;
            this._mouthful_btnR.filters = _loc2_.Mouthful == 0 ? ComponentFactory.Instance.creatFilters("grayFilter") : ComponentFactory.Instance.creatFilters("lightFilter");
            this._bid_btnR.enable = this._bid_btn.enable = _loc2_.BuyerID == PlayerManager.Instance.Self.ID ? false : true;
            this._bid_btnR.filters = _loc2_.BuyerID == PlayerManager.Instance.Self.ID ? ComponentFactory.Instance.creatFilters("grayFilter") : ComponentFactory.Instance.creatFilters("lightFilter");
      ...
      private function __cannel() : void
      {
         ...
         if(Boolean(_loc1_))
         {
            this._mouthful_btnR.enable = this._mouthful_btn.enable = _loc1_.Mouthful == 0 ? false : true;
            this._mouthful_btnR.filters = _loc1_.Mouthful == 0 ? ComponentFactory.Instance.creatFilters("grayFilter") : ComponentFactory.Instance.creatFilters("lightFilter");
            this._bid_btnR.enable = this._bid_btn.enable = _loc1_.BuyerID == PlayerManager.Instance.Self.ID ? false : true;
            this._bid_btnR.filters = _loc1_.BuyerID == PlayerManager.Instance.Self.ID ? ComponentFactory.Instance.creatFilters("grayFilter") : ComponentFactory.Instance.creatFilters("lightFilter");
         }
         else
         {
