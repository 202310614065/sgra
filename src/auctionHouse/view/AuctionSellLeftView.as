package auctionHouse.view
{
   ...
   public class AuctionSellLeftView extends Sprite implements Disposeable
   {
      ...
      {
         var _loc1_:MutipleImage = ComponentFactory.Instance.creat("auctionHouse.LeftBG2");
         addChild(_loc1_);
         var _loc2_:Bitmap = ComponentFactory.Instance.creatBitmap("asset.ddtauction.Sellbg");
         addChild(_loc2_);
         _loc2_.y = 57;
         var _loc3_:Bitmap = ComponentFactory.Instance.creatBitmap("asset.ddtauction.Sellbg");
         addChild(_loc3_);
         _loc3_.y = 302;
         var _loc4_:MovieImage = ComponentFactory.Instance.creatComponentByStylename("ddtauction.sellItemBG1");
         addChild(_loc4_);
         var _loc5_:MovieImage = ComponentFactory.Instance.creatComponentByStylename("ddtauction.sellItemBG2");
         addChild(_loc5_);
         var _loc6_:Scale9CornerImage = ComponentFactory.Instance.creatComponentByStylename("ddtauction.sellItemBG3");
         addChild(_loc6_);
         var _loc7_:Scale9CornerImage = ComponentFactory.Instance.creatComponentByStylename("ddtauction.sellItemBG4");
         addChild(_loc7_);
         var _loc8_:FilterFrameText = ComponentFactory.Instance.creatComponentByStylename("auctionHouse.SellViewTextI");
         _loc8_.text = LanguageMgr.GetTranslation("tank.ddtauctionHouse.view.text");
         addChild(_loc8_);
         var _loc9_:FilterFrameText = ComponentFactory.Instance.creatComponentByStylename("auctionHouse.SellViewTextII");
         _loc9_.text = LanguageMgr.GetTranslation("tank.ddtauctionHouse.view.text1");
         addChild(_loc9_);
         var _loc10_:FilterFrameText = ComponentFactory.Instance.creatComponentByStylename("auctionHouse.SellViewTextIII");
         _loc10_.text = LanguageMgr.GetTranslation("tank.ddtauctionHouse.view.text2");
         addChild(_loc10_);
         var _loc11_:FilterFrameText = ComponentFactory.Instance.creatComponentByStylename("auctionHouse.SellViewTextIIII");
         _loc11_.text = LanguageMgr.GetTranslation("tank.ddtauctionHouse.view.text3");
         addChild(_loc11_);
         var _loc12_:FilterFrameText = ComponentFactory.Instance.creatComponentByStylename("auctionHouse.SellViewTextIIIII");
         _loc12_.text = LanguageMgr.GetTranslation("tank.ddtauctionHouse.view.text4");
         addChild(_loc12_);
         var _loc13_:FilterFrameText = ComponentFactory.Instance.creatComponentByStylename("auctionHouse.SellViewtimerTextI");
         _loc13_.text = LanguageMgr.GetTranslation("tank.ddtauctionHouse.view.timer8");
         addChild(_loc13_);
         var _loc14_:FilterFrameText = ComponentFactory.Instance.creatComponentByStylename("auctionHouse.SellViewtimerTextII");
         _loc14_.text = LanguageMgr.GetTranslation("tank.ddtauctionHouse.view.timer24");
         addChild(_loc14_);
         var _loc15_:FilterFrameText = ComponentFactory.Instance.creatComponentByStylename("auctionHouse.SellViewtimerTextIII");
         _loc15_.text = LanguageMgr.GetTranslation("tank.ddtauctionHouse.view.timer48");
         addChild(_loc15_);
         var _loc16_:FilterFrameText = ComponentFactory.Instance.creatComponentByStylename("auctionHouse.SellViewhelpText");
         _loc16_.text = LanguageMgr.GetTranslation("tank.ddtauctionHouse.view.text5");
         addChild(_loc16_);
         var _loc17_:MutipleImage = ComponentFactory.Instance.creat("auctionHouse.SellLeftIcon0");
         addChild(_loc17_);
         var _loc18_:MutipleImage = ComponentFactory.Instance.creat("auctionHouse.SellLeftIcon1");
         addChild(_loc18_);
         var _loc19_:MutipleImage = ComponentFactory.Instance.creat("auctionHouse.SellLeftIcon2");
         addChild(_loc19_);
      ...
      private function initInfo() : void
      {
         ...
         if(SharedManager.Instance.AuctionInfos != null && SharedManager.Instance.AuctionInfos[this._cell.info.Name] != null)
         {
            ...
            if(_loc1_.itemType != this._cell.info.Data || _loc1_.itemLevel != this._cell.info.Level)
            {
            ...
            if(Boolean(_loc1_))
            {
               ...
               if(Number(_loc1_.startPrice) > Number(this._startMoney.text))
               {
      ...
      private function __startBid(param1:MouseEvent) : void
      {
         ...
         if(this._sellLoudBtn.selected)
         {
            if(SharedManager.Instance.isAuctionHouseTodayUseBugle)
            {
               ...
               alert1.addEventListener(FrameEvent.RESPONSE,function(param1:FrameEvent):void
               {
      ...
      public function sendFastAuctionBugle(param1:int = 11101) : void
      {
         if(PlayerManager.Instance.Self.PropBag.getItemCountByTemplateId(param1,true) <= 0)
         {
            ...
            {
               this._shopBugle = new NewShopBugleView(param1);
            }
            else if(this._shopBugle.type != param1)
            {
      ...
      private function auctionGood() : void
      {
         ...
         if(Boolean(this._cell.info))
         {
            ...
            _loc4_ = this._mouthfulM.text == "" ? 0 : int(Math.floor(Number(this._mouthfulM.text)));
            _loc5_ = this._selectRate - 1;
            _loc6_ = this._cell.goodsCount;
            SocketManager.Instance.out.auctionGood(_loc1_,_loc2_,1,_loc3_,_loc4_,_loc5_,_loc6_,this._sellLoudBtn.selected);
            _loc7_ = {};
            _loc7_.itemName = this._cell.info.Name;
            _loc7_.itemType = this._cell.info.Data;
            _loc7_.itemLevel = this._cell.info.Level;
