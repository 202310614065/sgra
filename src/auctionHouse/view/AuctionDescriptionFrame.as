package auctionHouse.view
{
   ...
   public class AuctionDescriptionFrame extends Frame
   {
      ...
      private function initView() : void
      {
         ...
         var _loc1_:Scale9CornerImage = ComponentFactory.Instance.creatComponentByStylename("ddtauction.HelpFrame.FrameBg");
         this._view.addChild(_loc1_);
         var _loc2_:MovieImage = ComponentFactory.Instance.creatComponentByStylename("asset.ddtauctionHouse.NotesContent");
