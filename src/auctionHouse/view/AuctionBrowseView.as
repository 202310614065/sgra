package auctionHouse.view
{
   ...
   public class AuctionBrowseView extends Sprite implements Disposeable
   {
      ...
      {
         var _loc1_:AuctionGoodsInfo = this._right.getSelectInfo();
         return Boolean(_loc1_) ? _loc1_.Price : 0;
      }
      
      private function getMouthful() : int
      {
         var _loc1_:AuctionGoodsInfo = this._right.getSelectInfo();
         return Boolean(_loc1_) ? _loc1_.Mouthful : 0;
      }
      ...
      private function __selectRightStrip(param1:AuctionHouseEvent) : void
      {
         ...
         if(_loc2_.BuyerID == PlayerManager.Instance.Self.ID)
         {
            ...
            this._sendBtn.enable = this._askBtn.enable = this._mouthful_btnR.enable = this._mouthful_btn.enable = _loc2_.Mouthful == 0 ? false : true;
            this._askBtn.filters = this._sendBtn.filters = this._mouthful_btnR.filters = _loc2_.Mouthful == 0 ? ComponentFactory.Instance.creatFilters("grayFilter") : ComponentFactory.Instance.creatFilters("lightFilter");
            return;
         }
      ...
      private function init_FUL_BID_btnStatue() : void
      {
         ...
         this._sendBtn.enable = this._askBtn.enable = this._mouthful_btnR.enable = this._mouthful_btn.enable = _loc1_.Mouthful == 0 ? false : true;
         this._askBtn.filters = this._sendBtn.filters = this._mouthful_btnR.filters = _loc1_.Mouthful == 0 ? ComponentFactory.Instance.creatFilters("grayFilter") : ComponentFactory.Instance.creatFilters("lightFilter");
