package auctionHouse.view
{
   ...
   public class AuctionBagListView extends BagListView
   {
      ...
      override public function setData(param1:BagInfo) : void
      {
         ...
         {
            if(_cells[_loc3_] != null && _bagdata.items[_loc3_].IsBinds == false && _bagdata.items[_loc3_].TemplateID != EquipType.BATTLE_COMPANION && _bagdata.items[_loc3_].TemplateID != EquipType.MIDAUTUMN_PACKS)
            {
