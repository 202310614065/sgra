package auctionHouse.controller
{
   ...
   public class AuctionHouseController extends BaseStateView
   {
      ...
      public function AuctionHouseController(param1:Boolean = false, param2:String = "0")
      {
         super();
         this._isFastAuction = param1;
         if(param1)
         {
            this.initAuction(param2);
         }
      }
      
      public function initAuction(param1:String) : void
      {
      ...
      public function searchFastAuction(param1:String = "") : void
      {
         this.startLoadAuctionInfo(1,"",-1,-1,-1,-2,0,"false",param1);
      }
      ...
      private function startLoadAuctionInfo(param1:int, param2:String, param3:int, param4:int, param5:int, param6:int, param7:uint = 0, param8:String = "false", param9:String = "") : void
      {
         ...
         var _loc11_:BaseLoader = LoadResourceManager.Instance.createLoader(PathManager.solveRequestPath("AuctionPageList.ashx"),BaseLoader.REQUEST_LOADER,_loc10_);
         ...
         LoadResourceManager.Instance.startLoad(_loc11_);
      ...
      private function __searchResult(param1:AuctionAnalyzer) : void
      {
         ...
         else if(this._model.state == AuctionState.FASTAUCTION)
         {
            ...
            this._fastAuctionView = ComponentFactory.Instance.creat("auctionHouse.FastAuctionView",[_loc2_[0],this,this._model]);
      ...
      private function fastAuctionResponse(param1:FrameEvent) : void
      {
