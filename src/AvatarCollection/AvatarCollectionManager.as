   ...
   public class AvatarCollectionManager extends EventDispatcher
   {
      ...
      public function initShopItemInfoList() : void
      {
         ...
         if(!this._maleShopItemInfoList)
         {
            ...
            _loc1_ = [ShopType.MONEY_M_CLOTH,ShopType.MONEY_M_HAT,ShopType.MONEY_M_GLASS,ShopType.MONEY_M_HAIR,ShopType.MONEY_M_EYES,ShopType.MONEY_M_LIANSHI,ShopType.MONEY_M_WING];
         ...
         if(!this._femaleShopItemInfoList)
         {
            ...
            _loc4_ = [ShopType.MONEY_F_CLOTH,ShopType.MONEY_F_HAT,ShopType.MONEY_F_GLASS,ShopType.MONEY_F_HAIR,ShopType.MONEY_F_EYES,ShopType.MONEY_F_LIANSHI,ShopType.MONEY_F_WING];
