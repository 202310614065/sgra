package AvatarCollection.view
{
   ...
   public class AvatarCollectionUnitView extends Sprite implements Disposeable
   {
      ...
      private function autoSelect() : void
      {
         ...
         var _loc2_:int = int(_loc1_.getSize());
         if(_loc2_ > 0)
         {
            ...
            _loc3_ = int(_loc1_.indexOf(this._selectedValue));
      ...
      private function refreshList() : void
      {
         ...
         if(this._isFilter)
         {
            _loc2_ = int(this._dataList.length);
            _loc3_ = 0;
            while(_loc3_ < _loc2_)
            {
         ...
         {
            _loc4_ = int(this._dataList.length);
            _loc5_ = 0;
            while(_loc5_ < _loc4_)
            {
         ...
         this._list.list.updateListView();
         if(Boolean(this._selectedValue) && _loc1_.indexOf(this._selectedValue) == -1)
         {
            this._selectedValue = null;
         }
