package AvatarCollection.view
{
   ...
   public class AvatarCollectionMoneyView extends Sprite implements Disposeable
   {
      ...
      private function initView() : void
      {
         ...
         this._goldButton.tipData = LanguageMgr.GetTranslation("tank.view.bagII.GiftDirections",(_loc1_ + _loc2_).toString());
      ...
      {
         if(Boolean(param1.changedProperties[PlayerInfo.GOLD]) || Boolean(param1.changedProperties["myHonor"]))
         {
            this.refreshView();
         }
      }
      ...
      private function refreshView() : void
      {
         ...
         this._goldTxt.text = PlayerManager.Instance.Self.BandMoney.toString();
      }
