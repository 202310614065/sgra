package cardSystem.view
{
   ...
   public class UpGradeFrame extends Frame
   {
      ...
      private function initView() : void
      {
         ...
         this._BG = ComponentFactory.Instance.creatComponentByStylename("asset.upgradeFrame.bg");
         this._inputBg = ComponentFactory.Instance.creatBitmap("asset,ddtcardSystem.inputBg");
         this._inputBg1 = ComponentFactory.Instance.creatBitmap("asset,ddtcardSystem.inputBg");
         PositionUtils.setPos(this._inputBg1,"upgradeFrame.inputPos");
         this._inputBg1.width = 155;
         this._inputBg1.height = 20;
      ...
      private function __helpHandler(param1:MouseEvent) : void
      {
         ...
         if(this._helpFrame == null)
         {
            ...
            this._bg = ComponentFactory.Instance.creatComponentByStylename("ddtcardSystem.BG1");
            this._okBtn = ComponentFactory.Instance.creatComponentByStylename("UpGradeFrame.helpFrame.OK");
            this._content = ComponentFactory.Instance.creatComponentByStylename("ddtcardSystem.upgradeFrame.help");
            ...
            this._helpFrame.addToContent(this._bg);
