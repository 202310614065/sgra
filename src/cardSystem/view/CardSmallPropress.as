package cardSystem.view
{
   ...
   public class CardSmallPropress extends Component
   {
      ...
      {
         this._thuck = ComponentFactory.Instance.creatComponentByStylename("cardSystem.info.thunck1");
         addChild(this._thuck);
         this._graphics_thuck = ComponentFactory.Instance.creatBitmapData("card.info.Bitmap_thuck2");
         this._propgressLabel = ComponentFactory.Instance.creatComponentByStylename("CardSystem.info.LevelProgressText1");
