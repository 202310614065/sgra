package cardSystem.view.cardCollect
{
   ...
   public class CollectPreview extends Sprite implements Disposeable
   {
      ...
      {
         var _loc1_:Vector.<CardInfo> = null;
         var _loc16_:int = 0;
         var _loc17_:Array = null;
         var _loc18_:String = null;
         _loc1_ = CardControl.Instance.model.getSetsCardFromCardBag(this._itemInfo.ID);
         ...
         var _loc2_:int = int(this._itemInfo.cardIdVec.length);
         var _loc3_:int = 0;
         while(_loc3_ < 5)
         {
            if(_loc3_ < _loc2_)
         ...
         var _loc4_:int = PREVIEWCARD_ALL_LENGTH / _loc2_;
         var _loc5_:int = 18 + _loc4_ / 2 - PREVIEWCARD_WIDHT / 2 + 5;
         var _loc6_:int = 0;
         while(_loc6_ < _loc2_)
         {
