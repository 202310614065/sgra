package civil.view
{
   ...
   public class CivilPlayerInfoList extends Sprite implements Disposeable
   {
      ...
      public function MemberList(param1:Array) : void
      {
         ...
         var _loc2_:int = param1.length > MAXITEM ? MAXITEM : int(param1.length);
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_)
         {
            _loc4_ = new CivilPlayerItemFrame(_loc3_);
      ...
      private function __civilListHandle(param1:CivilEvent) : void
      {
         ...
         var _loc3_:int = _loc2_.length > MAXITEM ? MAXITEM : int(_loc2_.length);
         if(_loc3_ <= 0)
         {
         ...
         else
         {
            ...
            while(_loc4_ < _loc3_)
            {
               _loc5_ = new CivilPlayerItemFrame(_loc4_);
