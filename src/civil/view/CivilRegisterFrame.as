package civil.view
{
   ...
   public class CivilRegisterFrame extends Frame implements Disposeable
   {
      ...
      {
         this._registerBg = ComponentFactory.Instance.creatComponentByStylename("asset.ddtcivil.register.bg");
         addToContent(this._registerBg);
         this._nameBg = ComponentFactory.Instance.creatComponentByStylename("register.nameBg");
         addToContent(this._nameBg);
         this._titleImage = ComponentFactory.Instance.creatComponentByStylename("ddtcivil.register.RegisterTitle");
         DisplayUtils.setFrame(this._titleImage,1);
         addToContent(this._titleImage);
         this._nicknameLabel = ComponentFactory.Instance.creatComponentByStylename("ddtcivil.register.NicknameLabel");
         ...
         this._matrimonyLabel = ComponentFactory.Instance.creatComponentByStylename("ddtcivil.register.MatrimonyLabel");
         ...
         this._introductionLabel = ComponentFactory.Instance.creatComponentByStylename("ddtcivil.register.IntroductionLabel");
