   ...
   public class BagCell extends BaseCell
   {
      ...
      override public function dragDrop(param1:DragEffect) : void
      {
         ...
         if(param1.data is InventoryItemInfo)
         {
            ...
            {
               if(this._bagType == BagInfo.CONSORTIA || _loc2_.BagType == BagInfo.CONSORTIA)
               {
                  ...
                  else if(this._bagType != BagInfo.CONSORTIA)
                  {
                     ...
                     {
                        SocketManager.Instance.out.sendMoveGoods(BagInfo.CONSORTIA,_loc2_.Place,BagInfo.EQUIPBAG,-1,1);
                     }
                     else
                     {
               ...
               else if(_loc2_.BagType == this._bagType)
               {
                  ...
                  else if(EquipType.isHealStone(_loc2_))
                  {
                     ...
                     else if(PlayerManager.Instance.Self.Grade < int(_loc2_.Property1) && _loc2_.Place > 30)
                     {
                        SocketManager.Instance.out.sendMoveGoods(_loc2_.BagType,_loc2_.Place,_loc2_.BagType,this.place,_loc2_.Count);
                        param1.action = DragEffect.NONE;
                     }
      ...
      override public function dragStop(param1:DragEffect) : void
      {
         ...
         if(param1.action == DragEffect.MOVE && param1.target == null)
         {
            ...
            else if(Boolean(_loc2_) && _loc2_.BagType == 11)
            {
               param1.action = DragEffect.NONE;
               super.dragStop(param1);
            }
            ...
            else if(Boolean(_loc2_) && _loc2_.BagType == 21)
            {
               locked = false;
            }
      ...
      protected function __onCellResponse(param1:FrameEvent) : void
      {
         ...
         _loc2_.removeEventListener(FrameEvent.RESPONSE,this.__onCellResponse);
