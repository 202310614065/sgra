package bagAndInfo.bag
{
   ...
   public class BagListView extends SimpleTileList
   {
      ...
      public function setCellInfo(param1:int, param2:InventoryItemInfo) : void
      {
         if(param2 == null)
         {
            if(Boolean(this._cells[String(param1)]))
            {
      ...
      private function sortItems() : void
      {
         ...
         for(_loc2_ in this._bagdata.items)
         {
            ...
            if(this._cells[_loc2_] != null && Boolean(_loc3_))
            {
      ...
      private function _cellsSort(param1:Array) : void
      {
         ...
         while(_loc2_ < param1.length)
         {
            ...
            _loc5_ = int(this._cellVec.indexOf(param1[_loc2_]));
         ...
         for each(_loc3_ in _loc2_)
         {
            ...
            if(_loc4_ != -1)
            {
               ...
               if(Boolean(_loc8_))
               {
                  ...
                  if(Boolean(this._cells[String(_loc4_)].info))
                  {
