package bagAndInfo.bag
{
   ...
   public class SellGoodsFrame extends Frame
   {
      ...
      public function set itemInfo(param1:InventoryItemInfo) : void
      {
         ...
         if(param1.Name.length > 20)
         {
            this._nameTxt.text = param1.Name.substring(0,20) + "..";
         }
         else
         {
         ...
         var _loc2_:String = param1.ReclaimType == 1 ? LanguageMgr.GetTranslation("shop.ShopIIShoppingCarItem.gold") : (param1.ReclaimType == 2 ? LanguageMgr.GetTranslation("tank.gameover.takecard.gifttoken") : "");
         _loc3_ = "                                                       ";
         this._price.text = param1.Count * param1.ReclaimValue + "";
         this._price.visible = false;
         this._descript.htmlText = LanguageMgr.GetTranslation("bagAndInfo.sellFrame.explainTxt",param1.Count,this._price.text) + _loc3_.substr(0,this._price.text.length * 2 + 2) + _loc2_;
      }
