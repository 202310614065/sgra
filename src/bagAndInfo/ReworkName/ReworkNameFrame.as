package bagAndInfo.ReworkName
{
   ...
   public class ReworkNameFrame extends Frame
   {
      ...
      protected function setCheckTxt(param1:String, param2:Boolean = false) : void
      {
         if(param2)
         {
            this.state = Aviable;
      ...
      protected function createCheckLoader(param1:Function) : BaseLoader
      {
         ...
         var _loc3_:BaseLoader = LoadResourceManager.Instance.createLoader(PathManager.solveRequestPath(this._path),BaseLoader.REQUEST_LOADER,_loc2_);
      ...
      protected function checkNameCallBack(param1:ReworkNameAnalyzer) : void
      {
         ...
         this.setCheckTxt(_loc2_.@message,_loc2_.@value == "true");
      }
