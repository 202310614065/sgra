package bagAndInfo.info
{
   ...
   public class PlayerInfoViewControl
   {
      ...
      public static function view(param1:*, param2:Boolean = true, param3:Boolean = false) : void
      {
         _isBattle = param3;
         if(param1 && _isBattle)
         {
      ...
      public static function viewByID(param1:int, param2:int = -1, param3:Boolean = true, param4:Boolean = false) : void
      {
         var _loc5_:PlayerInfo = PlayerManager.Instance.findPlayer(param1,param2);
         view(_loc5_,param3,param4);
      }
