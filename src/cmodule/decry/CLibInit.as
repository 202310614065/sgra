package cmodule.decry
{
   ...
   public class CLibInit
   {
      ...
      public function init() : *
      {
         ...
         cmodule.decry.mstate.copyTo(saveState);
         try
         {
            runner.startSystem();
            while(true)
         ...
         {
            saveState.copyTo(cmodule.decry.mstate);
            if(!regged)
            {
