package cmodule.decry
{
   internal class CHeapAllocator implements ICAllocator
   {
      ...
      public function free(param1:int) : void
      {
         if(this.pfree == null)
         {
            this.pfree = new CProcTypemap(CTypemap.VoidType,[CTypemap.PtrType]).fromC([cmodule.decry._free]);
         }
         this.pfree(param1);
      }
      ...
      public function alloc(param1:int) : int
      {
         ...
         {
            this.pmalloc = new CProcTypemap(CTypemap.PtrType,[CTypemap.IntType]).fromC([cmodule.decry._malloc]);
         }
