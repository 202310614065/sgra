package cmodule.decry
{
   ...
   function AS3_ObjectValue(param1:Object, param2:String, param3:int) : void
   {
      ...
      while(_loc5_ < _loc4_.length)
      {
         ...
         cmodule.decry.mstate.ds.position = param3;
         _loc8_ = int(cmodule.decry.mstate.ds.readInt());
         param3 += 4;
         _loc9_ = _loc7_.createC(param1[_loc6_]);
         cmodule.decry.mstate.ds.position = _loc8_;
         _loc10_ = 0;
         while(_loc10_ < _loc9_.length)
         {
            cmodule.decry.mstate.ds.writeInt(_loc9_[_loc10_]);
            _loc10_++;
         }
         _loc5_ += 2;
      }
