package cmodule.decry
{
   ...
   internal class GLEByteArrayProvider
   {
      ...
      public static function get() : ByteArray
      {
         ...
         try
         {
            result = cmodule.decry.gdomainClass.currentDomain.domainMemory;
         }
         catch(e:*)
         {
         }
         if(!result)
         {
            ...
            try
            {
               result.length = cmodule.decry.gdomainClass.MIN_DOMAIN_MEMORY_LENGTH;
               cmodule.decry.gdomainClass.currentDomain.domainMemory = result;
            }
            catch(e:*)
            {
