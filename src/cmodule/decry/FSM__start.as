      ...
      final override public function work() : void
      {
         switch(state)
         {
            case 0:
               ...
               this.i2 += this.i0;
               this.i2 += 8;
               si32(this.i2,cmodule.decry._environ);
               if(this.i1 >= 1)
               {
            ...
            case 2:
               mstate.esp += 4;
               this.i0 = cmodule.decry.__2E_str1;
               this.i1 = 4;
               log(this.i1,mstate.gworker.stringFromPtr(this.i0));
               mstate.esp -= 8;
               this.i0 = cmodule.decry._decry;
               si32(this.i2,mstate.esp);
               si32(this.i0,mstate.esp + 4);
               state = 3;
               mstate.esp -= 4;
               mstate.funcs[cmodule.decry._AS3_Function]();
               return;
            case 3:
               this.i0 = mstate.eax;
               mstate.esp += 8;
               mstate.esp -= 8;
               this.i1 = cmodule.decry.__2E_str11110;
               si32(this.i1,mstate.esp);
               si32(this.i0,mstate.esp + 4);
               state = 4;
               mstate.esp -= 4;
               mstate.funcs[cmodule.decry._AS3_Object]();
               return;
            case 4:
               this.i1 = mstate.eax;
               mstate.esp += 8;
               ...
               state = 5;
               mstate.esp -= 4;
               mstate.funcs[cmodule.decry._AS3_Release]();
               return;
            case 5:
               mstate.esp += 4;
               this.i0 = 1;
