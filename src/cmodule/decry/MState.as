package cmodule.decry
{
   ...
   public class MState extends MemUser
   {
      ...
      public const syms:Object = cmodule.decry.gstate == null ? {} : cmodule.decry.gstate.syms;
      
      public const ds:ByteArray = cmodule.decry.gstate == null || cmodule.decry.gstate.ds == null ? GLEByteArrayProvider.get() : cmodule.decry.gstate.ds;
      ...
      public var funcs:Vector.<Object> = cmodule.decry.gstate == null ? new Vector.<Object>(1) : cmodule.decry.gstate.funcs;
      
      public var edx:int;
      
      public var system:CSystem = cmodule.decry.gstate == null ? null : cmodule.decry.gstate.system;
      ...
      public function MState(param1:Machine)
      {
         ...
         if(cmodule.decry.gstate == null)
         {
            this.ds.length += cmodule.decry.gstackSize;
