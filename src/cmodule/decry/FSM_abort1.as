      ...
      final override public function work() : void
      {
         switch(state)
         {
            case 0:
               ...
               mstate.esp -= 20480;
               this.i0 = li8(cmodule.decry.___cleanup_2E_b);
               this.i0 ^= 1;
               this.i0 &= 1;
               if(this.i0 == 0)
               {
            ...
            case 2:
               ...
               si32(this.i7,cmodule.decry._val_2E_939);
               this.i9 = cmodule.decry.__2E_str775;
               this.i10 = cmodule.decry.__2E_str643;
               this.i0 = this.i9;
               this.i1 = this.i3;
               log(this.i1,mstate.gworker.stringFromPtr(this.i0));
               this.i0 = this.i10;
            ...
            case 3:
               ...
               log(this.i1,mstate.gworker.stringFromPtr(this.i0));
               si32(this.i7,cmodule.decry._val_2E_939);
               this.i0 = cmodule.decry.__2E_str37;
               this.i1 = this.i3;
               log(this.i1,mstate.gworker.stringFromPtr(this.i0));
               mstate.esp -= 20;
               this.i0 = 10;
         ...
         this.i2 = cmodule.decry.__2E_str441;
         this.i3 = 4;
         this.i0 = this.i2;
         this.i1 = this.i3;
         log(this.i1,mstate.gworker.stringFromPtr(this.i0));
         mstate.esp -= 20;
         this.i4 = cmodule.decry.__2E_str95;
         this.i5 = cmodule.decry.__2E_str138;
         this.i6 = 34;
         this.i7 = 78;
