package cmodule.decry
{
   ...
   public final class FSM___umoddi3 extends Machine
   {
      ...
      public static function start() : void
      {
         ...
         _loc1_ = cmodule.decry.mstate.ebp + -8;
         cmodule.decry.mstate.esp -= 20;
         _loc2_ = li32(cmodule.decry.mstate.ebp + 8);
         _loc3_ = li32(cmodule.decry.mstate.ebp + 12);
         _loc4_ = li32(cmodule.decry.mstate.ebp + 16);
         _loc5_ = li32(cmodule.decry.mstate.ebp + 20);
         si32(_loc2_,cmodule.decry.mstate.esp);
         si32(_loc3_,cmodule.decry.mstate.esp + 4);
         si32(_loc4_,cmodule.decry.mstate.esp + 8);
         si32(_loc5_,cmodule.decry.mstate.esp + 12);
         si32(_loc1_,cmodule.decry.mstate.esp + 16);
         cmodule.decry.mstate.esp -= 4;
         FSM___qdivrem.start();
         _loc1_ = int(cmodule.decry.mstate.eax);
         _loc1_ = int(cmodule.decry.mstate.edx);
         cmodule.decry.mstate.esp += 20;
         _loc1_ = li32(cmodule.decry.mstate.ebp + -8);
         _loc2_ = li32(cmodule.decry.mstate.ebp + -4);
