package cmodule.decry
{
   ...
   internal class CStrUTF8Typemap extends CAllocedValueTypemap
   {
      ...
      override public function readValue(param1:int) : *
      {
         ...
         _loc2_ = 0;
         while(cmodule.decry.mstate.ds.readByte() != 0)
         {
            _loc2_++;
         }
         cmodule.decry.mstate.ds.position = param1;
         return cmodule.decry.mstate.ds.readUTFBytes(_loc2_);
      }
      ...
      {
         this.ByteArrayForString(String(param2)).readBytes(cmodule.decry.mstate.ds,param1);
      }
   }
}
