package cmodule.decry
{
   ...
   public final class FSM_malloc_pages extends Machine
   {
      ...
      public static function start() : void
      {
         ...
         _loc1_ += 4095;
         _loc2_ = li32(cmodule.decry._free_list);
         _loc3_ = _loc1_ & -4096;
         if(_loc2_ != 0)
         {
            _loc1_ = _loc2_;
            while(true)
            {
               ...
               if(uint(_loc2_) >= uint(_loc3_))
               {
                  ...
                  if(_loc2_ != _loc3_)
                  {
                     ...
                     {
                        _loc5_ = 2;
                        _loc6_ = li32(cmodule.decry._malloc_origo);
                        _loc7_ = _loc4_ >>> 12;
                        _loc8_ = _loc7_ - _loc6_;
                        _loc9_ = li32(cmodule.decry._page_dir);
                        _loc8_ <<= 2;
                        ...
                        _loc2_ = li8(cmodule.decry._malloc_junk_2E_b);
                        _loc2_ ^= 1;
                        _loc2_ &= 1;
                        if(_loc2_ == 0)
                        {
                     ...
                     cmodule.decry.mstate.eax = _loc4_;
                  ...
                  else
                  {
                     ...
                     if(uint(_loc1_) >= uint(_loc6_))
                     {
                        ...
                        {
                           _loc2_ = _loc1_ >>> 12;
                           _loc7_ = li32(cmodule.decry._malloc_origo);
                           _loc2_ += -1;
                           _loc7_ = _loc2_ - _loc7_;
                           si32(_loc7_,cmodule.decry._last_index);
                           si32(_loc1_,cmodule.decry._malloc_brk);
                           _loc1_ = li32(cmodule.decry._malloc_ninfo);
                           _loc2_ = _loc7_ + 1;
                           ...
                           {
                              _loc1_ = cmodule.decry.__2E_str8;
                              _loc2_ = 4;
                              _loc8_ = 0;
                              ...
                              if(_loc1_ != -1)
                              {
                                 _loc8_ = cmodule.decry.__2E_str311;
                                 _loc9_ = li32(cmodule.decry._malloc_ninfo);
                                 _loc10_ = li32(cmodule.decry._page_dir);
                                 _loc9_ <<= 2;
                                 _loc2_ <<= 10;
                                 memcpy(_loc1_,_loc10_,_loc9_);
                                 _loc1_ = _loc2_ & 0x3FFFFC00;
                                 si32(_loc1_,cmodule.decry._malloc_ninfo);
                                 si32(_loc7_,cmodule.decry._page_dir);
                                 _loc2_ = 4;
                                 _loc1_ = _loc8_;
                                 log(_loc2_,cmodule.decry.mstate.gworker.stringFromPtr(_loc1_));
                                 _loc1_ = _loc4_;
