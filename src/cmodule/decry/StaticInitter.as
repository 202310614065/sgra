package cmodule.decry
{
   public class StaticInitter
   {
      ...
      {
         cmodule.decry.gstate.gworker.mstate._mw16(param1,param2);
      }
      ...
      {
         cmodule.decry.gstate.gworker.mstate._mw32(param1,param2);
      }
      ...
      public function alloc(param1:int, param2:int) : int
      {
         ...
         this.ptr = Boolean(this.ptr) ? this.ptr : (Boolean(cmodule.decry.gstate.ds.length) ? int(cmodule.decry.gstate.ds.length) : 1024);
         this.ptr = this.ptr + param2 - 1 & ~(param2 - 1);
         var _loc3_:int = this.ptr;
         this.ptr += param1;
         cmodule.decry.gstate.ds.length = this.ptr;
         return _loc3_;
      }
      ...
      {
         cmodule.decry.gstate.gworker.mstate._mw8(param1,param2);
      }
