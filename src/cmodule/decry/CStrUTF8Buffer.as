package cmodule.decry
{
   ...
   internal class CStrUTF8Buffer extends CBuffer
   {
      ...
      override protected function computeValue() : *
      {
         ...
         cmodule.decry.mstate.ds.position = this.ptr;
         while(Boolean(_loc2_--) && cmodule.decry.mstate.ds.readByte() != 0)
         {
            _loc1_++;
         }
         cmodule.decry.mstate.ds.position = this.ptr;
         return cmodule.decry.mstate.ds.readUTFBytes(_loc1_);
      }
      ...
      override protected function setValue(param1:*) : void
      {
         ...
         _loc2_.position = 0;
         _loc2_.readBytes(cmodule.decry.mstate.ds,this.ptr);
      }
   }
}
