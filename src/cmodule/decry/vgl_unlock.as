package cmodule.decry
{
   ...
   {
      if(cmodule.decry.gvglbmd && cmodule.decry.gvglpixels)
      {
         cmodule.decry.gstate.ds.position = cmodule.decry.gvglpixels;
         cmodule.decry.gvglbmd.setPixels(cmodule.decry.gvglbmd.rect,cmodule.decry.gstate.ds);
      }
   }
}
