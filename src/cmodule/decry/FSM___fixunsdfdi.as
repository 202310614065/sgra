package cmodule.decry
{
   ...
   public final class FSM___fixunsdfdi extends Machine
   {
      ...
      public static function start() : void
      {
         ...
         _loc6_ = lf64(cmodule.decry.mstate.ebp + 8);
         if(_loc6_ < _loc5_)
         {
            _loc5_ = 0;
            if(_loc6_ >= _loc5_)
            {
               ...
               si32(_loc2_,cmodule.decry.mstate.esp + 4);
               cmodule.decry.mstate.esp -= 4;
               cmodule.decry.mstate.funcs[cmodule.decry.___floatdidf]();
               _loc5_ = Number(cmodule.decry.mstate.st0);
