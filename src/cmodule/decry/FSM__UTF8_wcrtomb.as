package cmodule.decry
{
   ...
   public final class FSM__UTF8_wcrtomb extends Machine
   {
      ...
      public static function start() : void
      {
         ...
         _loc1_ = li32(cmodule.decry.mstate.ebp + 16);
         _loc2_ = li32(cmodule.decry.mstate.ebp + 8);
         _loc1_ = li32(_loc1_ + 4);
         _loc3_ = li32(cmodule.decry.mstate.ebp + 12);
         _loc4_ = _loc2_;
         if(_loc1_ != 0)
         {
            _loc2_ = 22;
            si32(_loc2_,cmodule.decry._val_2E_939);
            _loc2_ = -1;
         ...
         else
         {
            if(_loc2_ != 0)
            {
               ...
               else
               {
                  ...
                  {
                     _loc1_ = 86;
                     si32(_loc1_,cmodule.decry._val_2E_939);
                     _loc1_ = -1;
                  }
                  addr01ea:
