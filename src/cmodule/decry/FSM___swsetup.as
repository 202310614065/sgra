      ...
      final override public function work() : void
      {
         switch(state)
         {
            case 0:
               ...
               this.i1 = li8(cmodule.decry.___sdidinit_2E_b);
               if(this.i1 == 0)
               {
                  this.i1 = cmodule.decry._usual;
                  this.i2 = cmodule.decry._usual_extra;
                  this.i3 = 0;
                  this.i1 += 56;
                  do
                  {
                  ...
                  this.i1 = 1;
                  si8(this.i1,cmodule.decry.___cleanup_2E_b);
                  si8(this.i1,cmodule.decry.___sdidinit_2E_b);
               }
