package cmodule.decry
{
   ...
   public final class FSM___fixdfdi extends Machine
   {
      ...
      public static function start() : void
      {
         ...
         _loc4_ = 0;
         _loc5_ = lf64(cmodule.decry.mstate.ebp + 8);
         if(_loc5_ < _loc4_)
         {
            ...
            {
               _loc1_ = 0;
               cmodule.decry.mstate.esp -= 8;
               _loc5_ = -_loc5_;
               sf64(_loc5_,cmodule.decry.mstate.esp);
               cmodule.decry.mstate.esp -= 4;
               cmodule.decry.mstate.funcs[cmodule.decry.___fixunsdfdi]();
               _loc2_ = int(cmodule.decry.mstate.eax);
               _loc3_ = int(cmodule.decry.mstate.edx);
               cmodule.decry.mstate.esp += 8;
         ...
         else
         {
            ...
            else
            {
               ...
               _loc2_ = int(cmodule.decry.mstate.edx);
               cmodule.decry.mstate.esp += 8;
