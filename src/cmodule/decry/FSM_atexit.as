      ...
      final override public function work() : void
      {
         switch(state)
         {
            case 0:
               ...
               mstate.esp -= 0;
               this.i0 = li32(cmodule.decry.___atexit);
               this.i1 = li32(mstate.ebp + 8);
               if(this.i0 == 0)
               {
                  this.i0 = cmodule.decry.___atexit0_2E_2520;
                  si32(this.i0,cmodule.decry.___atexit);
                  break;
               }
               this.i2 = this.i0;
               addr0225:
            ...
            case 1:
               ...
               if(this.i2 != 0)
               {
                  this.i3 = li32(cmodule.decry.___atexit);
                  if(this.i0 != this.i3)
                  {
                     this.i0 = 0;
                     mstate.esp -= 8;
                  ...
                  si32(this.i2,cmodule.decry.___atexit);
                  this.i0 = this.i2;
                  this.i2 = this.i0;
                  §§goto(addr0225);
               }
