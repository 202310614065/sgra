package cmodule.decry
{
   ...
   public final class FSM___moddi3 extends Machine
   {
      ...
      public static function start() : void
      {
         ...
         _loc3_ = li32(cmodule.decry.mstate.ebp + 20);
         _loc4_ = li32(cmodule.decry.mstate.ebp + 8);
         _loc5_ = _loc2_ >> 31;
         _loc6_ = li32(cmodule.decry.mstate.ebp + 16);
         _loc7_ = _loc3_ >> 31;
         ...
         _loc4_ ^= _loc5_;
         si32(_loc4_,cmodule.decry.mstate.esp);
         si32(_loc7_,cmodule.decry.mstate.esp + 4);
         si32(_loc6_,cmodule.decry.mstate.esp + 8);
         si32(_loc3_,cmodule.decry.mstate.esp + 12);
         ...
         _loc3_ = li32(cmodule.decry.mstate.ebp + -4);
         if(_loc2_ <= -1)
         {
            _loc2_ = 0;
