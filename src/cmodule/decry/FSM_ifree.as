   ...
   public final class FSM_ifree extends Machine
   {
      ...
      public static function start() : void
      {
         ...
         while(true)
         {
            ...
            _loc1_ = li32(cmodule.decry._malloc_origo);
            _loc2_ = _loc3_ >>> 12;
            ...
            _loc6_ = li32(cmodule.decry._last_index);
            if(uint(_loc4_) > uint(_loc6_))
            {
               break;
            }
            _loc6_ = li32(cmodule.decry._page_dir);
            _loc7_ = _loc4_ << 2;
            ...
            if(uint(_loc8_) > uint(3))
            {
               ...
               _loc6_ = li8(cmodule.decry._malloc_junk_2E_b);
               _loc6_ ^= 1;
               _loc6_ &= 1;
               if(_loc6_ == 0)
               {
               ...
               _loc3_ = li32(cmodule.decry._malloc_origo);
               _loc1_ >>>= 12;
               _loc1_ -= _loc3_;
               _loc1_ <<= 2;
               ...
               {
                  cmodule.decry.mstate.esp -= 4;
                  si32(_loc2_,cmodule.decry.mstate.esp);
                  cmodule.decry.mstate.esp -= 4;
                  FSM_ifree.start();
                  cmodule.decry.mstate.esp += 4;
               }
            ...
            _loc5_ = _loc1_;
            _loc1_ = li8(cmodule.decry._malloc_junk_2E_b);
            _loc1_ ^= 1;
            _loc1_ &= 1;
            if(_loc1_ == 0)
            {
            ...
            _loc1_ = li8(cmodule.decry._malloc_hint_2E_b);
            _loc1_ ^= 1;
            _loc1_ &= 1;
            if(_loc1_ == 0)
            {
               _loc1_ = cmodule.decry.__2E_str4;
               _loc8_ = 4;
               _loc2_ = _loc8_;
               log(_loc2_,cmodule.decry.mstate.gworker.stringFromPtr(_loc1_));
            }
            _loc1_ = li32(cmodule.decry._px);
            ...
            else
            {
               ...
               cmodule.decry.mstate.esp -= 4;
               FSM_imalloc.start();
               _loc1_ = int(cmodule.decry.mstate.eax);
               cmodule.decry.mstate.esp += 4;
               si32(_loc1_,cmodule.decry._px);
               _loc2_ = _loc1_;
            }
            si32(_loc3_,_loc1_ + 8);
            si32(_loc8_,_loc2_ + 12);
            si32(_loc5_,_loc2_ + 16);
            _loc1_ = li32(cmodule.decry._free_list);
            if(_loc1_ == 0)
            {
               _loc5_ = cmodule.decry._free_list;
               si32(_loc1_,_loc2_);
               si32(_loc5_,_loc2_ + 4);
               si32(_loc2_,cmodule.decry._free_list);
               _loc1_ = 0;
               si32(_loc1_,cmodule.decry._px);
               _loc1_ = li32(_loc2_);
               if(_loc1_ != 0)
               ...
               else
               {
                  ...
                  _loc8_ = li32(cmodule.decry._malloc_cache);
                  _loc2_ = _loc3_ + 16;
                  if(uint(_loc5_) > uint(_loc8_))
                  {
                     _loc5_ = li32(_loc3_ + 12);
                     _loc8_ = li32(cmodule.decry._malloc_brk);
                     _loc4_ = _loc3_ + 12;
                     if(_loc5_ == _loc8_)
                     {
                        _loc5_ = 0;
                        ...
                        if(_loc5_ == _loc8_)
                        {
                           ...
                           _loc5_ = li32(cmodule.decry._malloc_cache);
                           _loc3_ += _loc5_;
                           si32(_loc3_,_loc4_);
                           si32(_loc5_,_loc2_);
                           _loc3_ = _brk(_loc3_);
                           _loc3_ = li32(_loc4_);
                           si32(_loc3_,cmodule.decry._malloc_brk);
                           _loc5_ = li32(cmodule.decry._malloc_origo);
                           _loc8_ = li32(cmodule.decry._last_index);
                           _loc3_ >>>= 12;
                           _loc2_ = _loc3_ - _loc5_;
                           if(uint(_loc2_) <= uint(_loc8_))
                           {
                              _loc3_ -= _loc5_;
                              _loc5_ = li32(cmodule.decry._page_dir);
                              _loc4_ = _loc3_ << 2;
                              _loc5_ += _loc4_;
                              do
                              {
                           ...
                           _loc3_ = _loc2_ + -1;
                           si32(_loc3_,cmodule.decry._last_index);
                        }
                        else
                        {
                           addr0511:
