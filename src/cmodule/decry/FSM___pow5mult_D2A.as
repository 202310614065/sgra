      ...
      final override public function work() : void
      {
         ...
         switch(state)
         {
            case 0:
               ...
               if(this.i2 != 0)
               {
                  this.i3 = cmodule.decry._p05_2E_3275;
                  this.i2 <<= 2;
                  this.i2 += this.i3;
            ...
            case 1:
               ...
               {
                  this.i0 = li32(cmodule.decry._p5s);
                  if(this.i0 != 0)
                  {
                     break;
                  }
                  this.i0 = li32(cmodule.decry._freelist + 4);
                  if(this.i0 != 0)
                  {
                     this.i3 = li32(this.i0);
                     si32(this.i3,cmodule.decry._freelist + 4);
                  }
                  else
                  {
                     this.i0 = cmodule.decry._private_mem;
                     this.i3 = li32(cmodule.decry._pmem_next);
                     ...
                     this.i0 = 1;
                     this.i4 = this.i3 + 32;
                     si32(this.i4,cmodule.decry._pmem_next);
                  ...
                  si32(this.i0,cmodule.decry._p5s);
