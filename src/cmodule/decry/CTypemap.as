package cmodule.decry
{
   ...
   internal class CTypemap
   {
      ...
      {
         var _loc3_:Array = this.createC(param2);
         cmodule.decry.mstate.ds.position = param1;
         var _loc4_:int = 0;
         while(_loc4_ < _loc3_.length)
         {
            cmodule.decry.mstate.ds.writeInt(_loc3_[_loc4_]);
            _loc4_++;
         }
      }
      ...
      public function readValue(param1:int) : *
      {
         ...
         {
            _loc2_.push(cmodule.decry.mstate.ds.readInt());
            _loc3_++;
         }
      ...
      {
         var _loc2_:Array = [param1.eax];
         var _loc3_:* = this.fromC(_loc2_);
