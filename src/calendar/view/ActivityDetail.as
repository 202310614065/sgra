package calendar.view
{
   ...
   public class ActivityDetail extends Sprite implements Disposeable
   {
      ...
      {
         this._discriptionField = ComponentFactory.Instance.creatComponentByStylename("ddtcalendar.ActivityState.DescriptionField");
      ...
      public function setData(param1:ActiveEventsInfo) : void
      {
         ...
         this._award.y = this._lines[0].y + this._lines[0].height + 4;
         ...
         this._lines[1].y = this._awardField.y + this._awardField.height + 8;
         this._content.y = this._lines[1].y + this._lines[1].height + 4;
         ...
         if(this._hasKey == 1 || this._hasKey == 7)
         {
            ...
            this._lines[2].y = this._input.y + this._input.height + 14;
         }
         else
         {
            this._input.visible = this._inputField.visible = false;
            this._lines[2].y = this._contentField.y + this._contentField.height + 8;
         }
         this._timeField.y = this._lines[2].y + this._lines[2].height + 8;
