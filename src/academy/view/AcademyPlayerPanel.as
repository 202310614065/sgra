package academy.view
{
   ...
   public class AcademyPlayerPanel extends Sprite implements Disposeable
   {
      ...
      private function init() : void
      {
         ...
         this._equipBtn.text = LanguageMgr.GetTranslation("civil.leftview.equipName.short");
      ...
      private function update() : void
      {
         ...
         if(Boolean(this._info))
         {
            ...
            var _loc2_:Number = _loc1_.TotalCount > 0 ? _loc1_.WinCount / _loc1_.TotalCount * 100 : 0;
            ...
            this._online.visible = _loc1_.playerState.StateID == PlayerState.ONLINE ? true : false;
