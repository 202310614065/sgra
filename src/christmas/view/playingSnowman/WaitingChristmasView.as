package christmas.view.playingSnowman
{
   ...
   public class WaitingChristmasView extends Component
   {
      ...
      private var _loadingArr:Array = ["loading","loading.","loading..","loading..."];
      ...
      public function WaitingChristmasView()
      {
         super();
      ...
      {
         dispatchEvent(new ChristmasRoomEvent(ChristmasRoomEvent.ENTER_GAME_TIME_OUT));
      }
      ...
      private function initView() : void
      {
         ...
         this._loadingText = ComponentFactory.Instance.creatComponentByStylename("christmas.WaitingView.loadingText");
         this._loadingText.text = this._loadingArr[0];
         this._timeText = ComponentFactory.Instance.creatComponentByStylename("christmas.WaitingView.timeText");
