package ddt.manager
{
   ...
   public class PathManager
   {
      ...
      public static function solveGoodsPath(param1:Number, param2:String, param3:Boolean = true, param4:String = "show", param5:String = "A", param6:String = "1", param7:int = 1, param8:Boolean = false, param9:int = 0, param10:String = "") : String
      {
         ...
         if(param1 == EquipType.MAGIC_STONE)
         {
            return info.SITE + "image/unfrightprop/" + param2 + "/" + _loc18_;
         }
      ...
      public static function vietnamCommunityInterfacePath(param1:String) : String
      {
         return info.OVERSEAS_COMMUNITY_PATH.concat(param1);
      }
      ...
      public static function savePageLink() : String
      {
         return info.SAVE_PAGE_LINK;
      }
      
      public static function get buyPetExt_Enable() : Boolean
      {
         return info.BUYPETEXP_ENABLE;
      }
      ...
      {
         return info.FACEBOOK_FEEDJS_FUNCTION;
      }
      
      public static function get facebookInviteFriendsJS() : String
      {
         return info.FACEBOOK_INVITE_FRIENDS;
      }
      
      public static function get facebookFeedTitleLink() : String
      {
         return info.FACEBOOK_FEED_TITLE_LINK;
      }
      
      public static function get turkey337VipEnable() : Boolean
      {
         return info.TURKEY_337_VIPPAGE_ENABLE;
      }
      
      public static function get turkey337VipPage() : String
      {
         return info.TURKEY_337_VIPPAGE_LINK;
      }
      
      public static function get turkey337VipPageJS() : String
      {
         return info.TURKEY_337_VIPPAGE_JS;
      }
