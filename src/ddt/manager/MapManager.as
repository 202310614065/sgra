package ddt.manager
{
   ...
   public class MapManager extends EventDispatcher
   {
      ...
      public static function getListByType(param1:int = 0) : *
      {
         ...
         if(param1 == PVE_ACTIVITY_MAP || param1 == PVE_SPECIAL_MAP)
         {
      ...
      public static function setupDungeonInfo(param1:DungeonAnalyzer) : void
      {
         ...
         while(_loc2_ < _pveList.length)
         {
            ...
            if(MapManager.PVE_ADVANCED_MAP.indexOf(_loc3_.ID) != -1 || PathManager.footballEnable && _loc3_.ID == 14)
            {
            ...
            else if(_loc3_.Type == PVE_ACTIVITY_MAP || _loc3_.Type == PVE_SPECIAL_MAP)
            {
