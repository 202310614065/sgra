   ...
   public class ServerManager extends EventDispatcher
   {
      ...
      private function __onLoginComplete(param1:CrazyTankSocketEvent) : void
      {
         ...
         if(_loc2_.readByte() == 0)
         {
            ...
            _loc3_.BandMoney = _loc2_.readInt();
            _loc2_.readInt();
            ...
            _loc3_.CardSoul = _loc2_.readInt();
            _loc3_.GetSoulCount = _loc2_.readInt();
            _loc3_.uesedFinishTime = _loc2_.readInt();
            ...
            _loc3_.isFirstDivorce = _loc2_.readInt();
            _loc3_.PveEpicPermission = _loc2_.readUTF();
