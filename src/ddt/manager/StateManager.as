package ddt.manager
{
   ...
   public class StateManager
   {
      ...
      private static function addNextToStage() : void
      {
         ...
         if(Boolean(_loc1_) && (!(_loc1_ is CampBattleView) || !(current is CampBattleView)))
         {
         ...
         if(RingStationManager.challenge && currentStateType == "main")
         {
      ...
      public static function createStateAsync(param1:String, param2:Function, param3:int = 0) : void
      {
         _creator.createAsync(param1,param2,param3);
      }
      ...
      {
         return param1 != StateType.FIGHTING && param1 != StateType.MATCH_ROOM && param1 != StateType.MISSION_ROOM && param1 != StateType.DUNGEON_ROOM && param1 != StateType.CHALLENGE_ROOM && param1 != StateType.ROOM_LOADING && param1 != StateType.ENCOUNTER_LOADING && param1 != StateType.FIGHT_LIB && param1 != StateType.TRAINER1 && param1 != StateType.TRAINER2 && param1 != StateType.FIGHT_LIB_GAMEVIEW && param1 != StateType.CONSORTIA_BATTLE_SCENE && param1 != StateType.CAMP_BATTLE_SCENE;
      }
