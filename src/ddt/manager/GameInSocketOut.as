package ddt.manager
{
   ...
   public class GameInSocketOut
   {
      ...
      {
         var _loc11_:int = PlayerManager.Instance.Self.Grade < 5 ? 4 : param6;
      ...
      {
         var _loc5_:int = PlayerManager.Instance.Self.Grade < 5 ? 4 : param3;
      ...
      {
         var _loc2_:PackageOut = new PackageOut(ePackageType.GAME_MISSION_START);
         _loc2_.writeBoolean(param1);
         sendPackage(_loc2_);
      }
      ...
      {
         var _loc1_:PackageOut = new PackageOut(ePackageType.GAME_ROOM);
         _loc1_.writeInt(GameRoomPackageType.GAME_ENERGY_NOT_ENOUGH);
         sendPackage(_loc1_);
      }
      ...
      public static function sendFightFootballTimeTakeOut(param1:int) : void
      {
         var _loc2_:PackageOut = new PackageOut(ePackageType.FIGHTFOOTBALLTIMETAKEOUT);
         _loc2_.writeByte(param1);
         sendPackage(_loc2_);
      }
      ...
      public static function sendTransnationalBegin(param1:int) : void
      {
         var _loc2_:PackageOut = new PackageOut(ePackageType.TRANSNATIONALFIGHT_ACTIVED);
         _loc2_.writeByte(param1);
         sendPackage(_loc2_);
      }
      
      public static function revertPlayerInfo(param1:int) : void
      {
         var _loc2_:PackageOut = new PackageOut(ePackageType.TRANSNATIONALFIGHT_ACTIVED);
         _loc2_.writeByte(param1);
         sendPackage(_loc2_);
      ...
      public static function sendEquipmentTransnational(param1:int) : void
      {
         var _loc2_:PackageOut = new PackageOut(ePackageType.TRANSNATIONALFIGHT_ACTIVED);
         _loc2_.writeByte(TransnationalPackageType.MOVE_EQUIPMENT);
         _loc2_.writeInt(param1);
         sendPackage(_loc2_);
      }
      ...
      {
         var _loc3_:PackageOut = new PackageOut(ePackageType.GAME_CMD);
         _loc3_.writeByte(CrazyTankPackageType.PAYMENT_TAKE_CARD);
      ...
      {
         var _loc4_:PackageOut = new PackageOut(ePackageType.GAME_CMD);
         _loc4_.writeByte(CrazyTankPackageType.GAME_MISSION_TRY_AGAIN);
         _loc4_.writeInt(param1);
      ...
      {
         var _loc3_:PackageOut = new PackageOut(ePackageType.GAME_CMD);
         _loc3_.writeByte(CrazyTankPackageType.SELECT_OBJECT);
         _loc3_.writeInt(param1);
         _loc3_.writeInt(param2);
         sendPackage(_loc3_);
      }
      ...
      {
         var _loc1_:PackageOut = new PackageOut(ePackageType.DICE_SYSTEM);
         _loc1_.writeByte(12);
         sendPackage(_loc1_);
      }
      ...
      {
         var _loc3_:PackageOut = new PackageOut(ePackageType.DICE_SYSTEM);
         _loc3_.writeByte(11);
         _loc3_.writeInt(param1);
         _loc3_.writeInt(param2);
         sendPackage(_loc3_);
      ...
      {
         var _loc2_:PackageOut = new PackageOut(ePackageType.ACTIVITY_SYSTEM);
         _loc2_.writeByte(PyramidPackageType.PYRAMID_DIEEVENT);
         _loc2_.writeBoolean(param1);
         sendPackage(_loc2_);
      }
      
      public static function sendFightFootballTimeBegin(param1:int) : void
      {
      }
      
      public static function sendKingDivisionGameStart(param1:int) : void
      {
         var _loc2_:PackageOut = new PackageOut(ePackageType.KING_DIVISION);
         _loc2_.writeByte(param1);
         sendPackage(_loc2_);
      }
      ...
      {
         var _loc1_:PackageOut = new PackageOut(ePackageType.KING_DIVISION);
         _loc1_.writeByte(KingDivisionPackageType.CONSORTIA_MATCH_SCORE);
         sendPackage(_loc1_);
      }
      ...
      {
         var _loc1_:PackageOut = new PackageOut(ePackageType.KING_DIVISION);
         _loc1_.writeByte(KingDivisionPackageType.CONSORTIA_MATCH_AREA_RANK);
         sendPackage(_loc1_);
      }
      ...
      {
         var _loc1_:PackageOut = new PackageOut(ePackageType.KING_DIVISION);
         _loc1_.writeByte(KingDivisionPackageType.CONSORTIA_MATCH_RANK);
         sendPackage(_loc1_);
      }
      ...
      {
         var _loc1_:PackageOut = new PackageOut(ePackageType.KING_DIVISION);
         _loc1_.writeByte(KingDivisionPackageType.CONSORTIA_MATCH_AREA_RANK_INFO);
         sendPackage(_loc1_);
      }
   }
}
