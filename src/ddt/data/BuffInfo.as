package ddt.data
{
   ...
   public class BuffInfo
   {
      ...
      {
         return this._ValidCount + this.additionCount;
      }
      ...
      {
         return this._buffItem != null ? int(this._buffItem.Property3) + this.additionCount : 0;
      }
      ...
      public function initItemInfo() : void
      {
         switch(this.Type)
         {
            ...
            case Train_Good:
               ...
               break;
            case LABYRINTH_STONE:
               this._buffItem = ItemManager.Instance.getTemplateById(EquipType.LABYINTH_DOBLE_AWARD);
               break;
            case DOUBLE_PRESTIGE:
               this._buffItem = ItemManager.Instance.getTemplateById(EquipType.DOUBLE_PRESTIGE);
               break;
            case GROW_HELP:
