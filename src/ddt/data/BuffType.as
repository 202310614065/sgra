package ddt.data
{
   public class BuffType
   {
      ...
      {
         return param1.type == Pay || param1.type == CONSORTIA || param1.type == CARD_BUFF;
      }
      
      public static function isActivityDunBuff(param1:FightBuffInfo) : Boolean
      {
         return param1.displayid == ActivityDungeonBubble || param1.displayid == ActivityDungeonNet;
      }
