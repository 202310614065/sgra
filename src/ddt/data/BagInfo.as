package ddt.data
{
   ...
   public class BagInfo extends EventDispatcher
   {
      ...
      public function findOvertimeItemsByBody() : Array
      {
         ...
         while(_loc2_ < 30)
         {
            if(Boolean(this._items[_loc2_] as InventoryItemInfo))
            {
      ...
      public function getItemCountByCategoryID(param1:int, param2:Boolean = true) : int
      {
         var _loc4_:InventoryItemInfo = null;
         var _loc3_:int = 0;
         for each(_loc4_ in this._items)
         {
            if(_loc4_.CategoryID == param1 && (!param2 || _loc4_.getRemainDate() > 0))
            {
               _loc3_ += _loc4_.Count;
            }
         }
      ...
      public function sortBag(param1:int, param2:BagInfo, param3:int, param4:int, param5:Boolean = false) : void
      {
         ...
         if(param1 != BagInfo.TASKBAG && param1 != BagInfo.BEADBAG && param1 != BagInfo.MAGICSTONE)
         {
            _loc6_ = param2.items;
            _loc7_ = [];
            _loc8_ = [];
            ...
            {
               if(int(_loc6_.list[_loc12_].Place) >= _loc11_ && int(_loc6_.list[_loc12_].Place) <= param4)
               {
                  _loc7_.push({
         ...
         else if(param1 == BagInfo.TASKBAG && param5)
         {
            this.sortCard();
         }
         else if(param1 == BagInfo.BEADBAG)
         {
            this.sortBead(param2,param3,param4,param5);
         }
         else if(param1 == BagInfo.MAGICSTONE)
         {
            this.sortMagicStone(param2,param3,param4);
         }
      }
      ...
      private function sortMagicStone(param1:BagInfo, param2:int, param3:int) : void
      {
         ...
         var _loc4_:DictionaryData = param1.items;
         var _loc5_:Array = [];
         var _loc6_:Array = [];
         for each(_loc7_ in _loc4_)
         {
            if(_loc7_.Place >= param2 && _loc7_.Place <= param3)
            {
               _loc5_.push({
                  "Property":this.propertyAssort(_loc7_),
                  "Quality":_loc7_.Quality,
                  "StrengthenLevel":_loc7_.StrengthenLevel,
                  "StrengthenExp":_loc7_.StrengthenExp,
                  "Place":_loc7_.Place,
                  "Name":_loc7_.Name,
                  "ItemID":_loc7_.ItemID,
                  "TemplateID":_loc7_.TemplateID
               });
            }
         }
         _loc8_ = new ByteArray();
         _loc8_.writeObject(_loc5_);
         _loc8_.position = 0;
         _loc6_ = _loc8_.readObject() as Array;
         _loc5_.sortOn(["Property","Quality","StrengthenLevel","StrengthenExp","Place"],[Array.NUMERIC,Array.NUMERIC | Array.DESCENDING,Array.NUMERIC | Array.DESCENDING,Array.NUMERIC | Array.DESCENDING,Array.NUMERIC]);
         if(this.bagComparison(_loc5_,_loc6_,param2))
         {
            return;
         }
         SocketManager.Instance.out.sortMgStoneBag(_loc5_,param2);
      }
      ...
      private function sortBead(param1:BagInfo, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var _loc7_:Array = [];
         var _loc8_:int = 0;
         var _loc9_:int = int(_loc5_.list.length);
         var _loc10_:int = 0;
