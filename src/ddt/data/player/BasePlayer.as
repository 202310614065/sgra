package ddt.data.player
{
   ...
   public class BasePlayer extends EventDispatcher
   {
      ...
      private var _isVIPLogin:Boolean;
      ...
      public function set Grade(param1:int) : void
      {
         ...
         {
            this.IsUpGrade = true;
            if(PathManager.facebookEnable && ExternalInterface.available && param1 >= 20)
            {
               OverSeasCommunController.instance().facebookSendToFeed(LanguageMgr.GetTranslation("community.facebook.feed.levelUp"));
            }
         }
         this._grade = param1;
      ...
      public function get isVIPLogin() : Boolean
      {
         return this._isVIPLogin;
      }
      
      public function set isVIPLogin(param1:Boolean) : void
      {
         this._isVIPLogin = param1;
      }
      ...
      public function set activityTanabataNum(param1:int) : void
      {
         ...
         this._activityTanabataNum = param1 < 0 ? 0 : param1;
      }
   }
}
