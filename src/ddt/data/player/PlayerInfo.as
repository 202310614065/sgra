package ddt.data.player
{
   ...
   public class PlayerInfo extends BasePlayer
   {
      ...
      {
         if(this._magicDefence == param1)
         {
            return;
         }
         this._magicDefence = param1;
      ...
      public function setAttackDefenseValues(param1:int, param2:int, param3:int, param4:int, param5:int, param6:int) : void
      {
         ...
         this.Agility = param3;
         this.Luck = param4;
         this.MagicAttack = param5;
         this.MagicDefence = param6;
      ...
      public function get SnapDeputyWeapon() : InventoryItemInfo
      {
         ...
         _loc1_.TemplateID = this.snapDeputyWeaponID;
      ...
      public function set snapPet(param1:PetInfo) : void
      {
         if(Boolean(param1))
         {
      ...
      public function set snapDeputyWeaponID(param1:int) : void
      {
         if(Boolean(param1))
         {
            this._snapDeputyWeaponID = param1;
      ...
      {
         this._isTrusteeship = param1;
         dispatchEvent(new GameEvent(GameEvent.TRUSTEESHIP_CHANGE,param1));
      }
      ...
      {
         this._fightStatus = param1;
         dispatchEvent(new GameEvent(GameEvent.FIGHT_STATUS_CHANGE,param1));
      }
