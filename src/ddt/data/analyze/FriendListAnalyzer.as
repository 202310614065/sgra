      ...
      override public function analyze(param1:*) : void
      {
         ...
         if(_loc2_.@value == "true")
         {
            ...
            while(_loc7_ < _loc6_.length())
            {
               ...
               _loc10_.isOld = int(_loc6_[_loc7_].@OldPlayer) == 1;
               _loc11_ = String(_loc6_[_loc7_].@LastDate).replace(/-/g,"/");
               _loc10_.LastLoginDate = new Date(_loc11_);
               if(_loc10_.Birthday != "Null")
               {
                  _loc13_ = _loc10_.Birthday.split(/-/g);
                  _loc10_.BirthdayDate = new Date();
                  _loc10_.BirthdayDate.fullYearUTC = Number(_loc13_[0]);
                  _loc10_.BirthdayDate.monthUTC = Number(_loc13_[1]) - 1;
                  _loc10_.BirthdayDate.dateUTC = Number(_loc13_[2]);
               }
               _loc12_ = new PlayerState(int(_loc2_.Item[_loc7_].@State));
