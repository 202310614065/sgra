      ...
      override public function analyze(param1:*) : void
      {
         ...
         if(_loc3_.@value == "true")
         {
            ...
            while(_loc6_ < _loc4_.length())
            {
               ...
               _loc8_ = int(_loc4_[_loc6_].@TemplateId);
               if(int(_loc7_) == EquipType.CADDY || int(_loc7_) == EquipType.BOMB_KING_BLESS || int(_loc7_) == EquipType.SILVER_BLESS || int(_loc7_) == EquipType.GOLD_BLESS || int(_loc7_) == EquipType.TREASURE_CADDY)
               {
               ...
               if(Boolean(this._boxTemplateID[_loc7_]))
               {
               ...
               if(Boolean(this.exploitTemplateIDs[_loc7_]))
               {
                  _loc5_ = new BoxGoodsTempInfo();
                  ObjectUtils.copyPorpertiesByXML(_loc5_,_loc4_[_loc6_]);
