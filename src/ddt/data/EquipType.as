package ddt.data
{
   ...
   public class EquipType
   {
      ...
      public static const LEGEND_TICKET_ID:int = 201105;
      ...
      public static const CARDSOUL_BOX2:int = 201266;
      ...
      public static const DOUBLE_EXP_CARD_VALIDATE:int = 11980;
      ...
      public static const football:int = 17011;
      ...
      public static const PASS_BALL:int = 10467;
      ...
      public static function canBeUsed(param1:ItemTemplateInfo) : Boolean
      {
         ...
         switch(param1.TemplateID)
         {
            ...
            case EquipType.DOUBLE_EXP_CARD_VALIDATE:
      ...
      {
         return param1.CategoryID == CARDBOX && param1.TemplateID != 20150 && param1.TemplateID != 201266;
      }
      ...
      public static function isValuableEquip(param1:ItemTemplateInfo) : Boolean
      {
         ...
         if(Boolean(_loc2_))
         {
            ...
            if(_loc2_.CategoryID == 17 && _loc2_.Property3 == "33")
            {
               return true;
            }
            if(_loc2_.CategoryID == 34)
            {
               return true;
            }
            return false;
      ...
      {
         return param1 == EquipType.MAGIC_STONE;
      }
