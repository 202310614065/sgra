package ddt.view.character
{
   ...
   public class BaseCharacterLoader implements ICharacterLoader
   {
      ...
      final public function load(param1:Function = null) : void
      {
         ...
         this.initLayers();
         var _loc2_:int = int(this._layers.length);
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_)
         {
      ...
      public function update() : void
      {
         ...
         var _loc11_:int = 0;
         if(this._info && this._info.Style && Boolean(this._layers))
         {
      ...
      public function dispose() : void
      {
         this._content = null;
         var _loc1_:int = 0;
         while(Boolean(this._layers) && _loc1_ < this._layers.length)
         {
