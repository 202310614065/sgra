package ddt.view.character
{
   ...
   public class GameCharacter extends BaseCharacter
   {
      ...
      override public function drawFrame(param1:int, param2:int = 0, param3:Boolean = true) : void
      {
         ...
         if(param2 == 1)
         {
            _loc4_ = this._faceDownBitmapdata != null ? this._faceDownBitmapdata : this._defaultFace;
         }
         else if(param2 == 2)
         {
            if(Boolean(this._lackHpFaceBitmapdata))
         ...
         else if(param2 == 3)
         {
            ...
            {
               _loc4_ = this._tempCryFace != null ? this._tempCryFace : this._defaultFace;
            }
            else
            {
               _loc4_ = this._faceBitmapData != null ? this._faceBitmapData : this._defaultFace;
            }
         }
         else if(param2 == 4)
         {
            _loc4_ = this._faceupBitmapData != null ? this._faceupBitmapData : this._defaultFace;
         }
         else if(param2 == 5)
         {
         ...
         {
            _loc4_ = this._normalSuit != null ? this._normalSuit : this._defaultFace;
         }
         else if(param2 == 7)
         {
            _loc4_ = this._lackHpSuit != null ? this._lackHpSuit : this._defaultFace;
         }
         else if(param2 == 8)
         {
            _loc4_ = this._soulFace != null ? this._soulFace : this._defaultFace;
         }
         ...
         else
         {
            ...
            _currentframe = param1;
            _body.bitmapData.copyPixels(_loc4_,_frames[param1],this._defaultStartPoint,null,null,true);
