package ddt.view.roulette
{
   ...
   public class TurnControl extends EventDispatcher
   {
      ...
      {
         var _loc4_:int = 0;
         var _loc3_:int = param1 - param2 < 0 ? param1 - param2 + this._goodsList.length : param1 - param2;
         if(_loc3_ == 1)
         {
         ...
         {
            _loc4_ = param1 - 1 < 0 ? param1 - 1 + this._goodsList.length : param1 - 1;
      ...
      private function get prevSelected() : int
      {
         ...
         {
            case TYPE_SPEED_UP:
               _loc1_ = this.sparkleNumber == 0 ? this._goodsList.length - 1 : this._sparkleNumber - 1;
               break;
            case TYPE_SPEED_UNCHANGE:
               _loc1_ = this.sparkleNumber - SHADOW_NUMBER < 0 ? this.sparkleNumber - SHADOW_NUMBER + this._goodsList.length : this.sparkleNumber - SHADOW_NUMBER;
               break;
            case TYPE_SPEED_DOWN:
               ...
               _loc2_ = this._moderationNumber >= 7 ? this._moderationNumber - 6 : 1;
               _loc1_ = this.sparkleNumber - _loc2_ < 0 ? this.sparkleNumber - _loc2_ + this._goodsList.length : this._sparkleNumber - _loc2_;
