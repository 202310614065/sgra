   ...
   public class RouletteView extends Sprite implements Disposeable
   {
      ...
      private function _getItem(param1:CrazyTankSocketEvent) : void
      {
         ...
         if(_loc3_)
         {
            ...
            this._selectedGoodsInfo = this.getTemplateInfo(_loc5_) as InventoryItemInfo;
            ...
            this._selectedItemType = _loc6_;
            this.turnSlectedNumber = this._findCellByItemID(_loc5_,this._selectedCount);
            this._selectedGoodsNumberInTemplateIDList = this._findSelectedGoodsNumberInTemplateIDList(_loc5_,this._selectedCount);
      ...
      {
         SoundManager.instance.play("008");
         var _loc2_:int = this._needKeyCount[this._selectNumber] == 0 ? 1 : int(this._needKeyCount[this._selectNumber]);
      ...
      {
         var _loc1_:Bitmap = ComponentFactory.Instance.creat("asset.awardSystem.roulette.StopAsset");
      ...
      private function _findCellByItemID(param1:int, param2:int) : int
      {
         ...
         {
            if(this._goodsList[_loc3_].info.TemplateID == param1 && this._goodsList[_loc3_].count == param2)
            {
               return _loc3_;
            }
            _loc3_++;
