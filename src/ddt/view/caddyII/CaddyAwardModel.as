package ddt.view.caddyII
{
   ...
   public class CaddyAwardModel
   {
      ...
      {
         this._awards = param1._awards;
         this._silverAwards = param1._silverAwards;
         this._goldAwards = param1._goldAwards;
         this._treasureAwards = param1._treasureAwards;
      }
