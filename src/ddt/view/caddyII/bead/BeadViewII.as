   ...
   public class BeadViewII extends RightView
   {
      ...
      private function showQuickBuyBead() : void
      {
         ...
         if(_type != EquipType.MYSTICAL_CARDBOX && _type != EquipType.MY_CARDBOX)
         {
            ...
            {
               _loc1_ = this._clickNumber;
            }
            this.openShortcutBuyFrame(_loc1_);
         }
         else
         {
      ...
      private function openShortcutBuyFrame(param1:int) : void
      {
         ...
         _loc2_.show(this._cellId,false,LanguageMgr.GetTranslation("tank.view.bead.quickBuyTitle"),5,param1,75);
      }
