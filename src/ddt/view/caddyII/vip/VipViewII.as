package ddt.view.caddyII.vip
{
   ...
   public class VipViewII extends RightView
   {
      ...
      private function initView() : void
      {
         ...
         _loc5_.text = LanguageMgr.GetTranslation("tank.view.award.getVip");
      ...
      private function getCardPlace(param1:int) : int
      {
         ...
         var _loc2_:Array = PlayerManager.Instance.Self.Bag.findCellsByTempleteID(this._vipID);
      ...
      {
         var _loc3_:InventoryItemInfo = null;
         var _loc2_:Array = PlayerManager.Instance.Self.PropBag.findCellsByTempleteID(this._vipID);
         for each(_loc3_ in _loc2_)
         {
            if(_loc3_.Place == param1)
            {
