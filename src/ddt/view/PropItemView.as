package ddt.view
{
   ...
   public class PropItemView extends Sprite implements ITipedDisplay, Disposeable
   {
      ...
      public static function createView(param1:String, param2:int = 62, param3:int = 62, param4:Boolean = true) : Bitmap
      {
         ...
         if(param1 != "wish")
         {
            _loc5_ = "game.crazyTank.view.Prop" + param1.toString() + "Asset";
            _loc6_ = ComponentFactory.Instance.creatBitmap(_loc5_);
            _loc6_.smoothing = param4;
            _loc6_.width = param2;
            _loc6_.height = param3;
            return _loc6_;
         }
         _loc7_ = ComponentFactory.Instance.creatBitmap("asset.game.wishBtn");
         _loc7_.smoothing = param4;
         _loc7_.width = param2;
