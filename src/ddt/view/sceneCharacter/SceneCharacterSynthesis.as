   ...
   public class SceneCharacterSynthesis
   {
      ...
      private function characterSynthesis() : void
      {
         ...
         for each(_loc4_ in this._sceneCharacterSet.dataSet)
         {
            ...
            if(Boolean(_loc4_.points) && _loc4_.points.length > 0)
            {
               ...
               {
                  _loc10_ = _loc4_.isRepeat ? _loc4_.repeatNumber : _loc4_.rowCellNumber;
                  _loc11_ = 0;
      ...
      private function characterGroupDraw(param1:SceneCharacterItem) : void
      {
         ...
         for each(_loc2_ in this._sceneCharacterSet.dataSet)
         {
            if(param1.groupType == _loc2_.groupType && _loc2_.type != param1.type)
            {
               ...
               param1.rowNumber = _loc2_.rowNumber > param1.rowNumber ? _loc2_.rowNumber : param1.rowNumber;
               param1.rowCellNumber = _loc2_.rowCellNumber > param1.rowCellNumber ? _loc2_.rowCellNumber : param1.rowCellNumber;
