package ddt.view.common.church
{
   ...
   public class ChurchDialogueAgreePropose extends BaseAlerFrame
   {
      ...
      private function initialize() : void
      {
         ...
         this._contentTxt = ComponentFactory.Instance.creat("common.church.churchDialogueAgreePropose.contentText");
         this._contentTxt.text = LanguageMgr.GetTranslation("common.church.churchDialogueAgreePropose.contentText.text");
