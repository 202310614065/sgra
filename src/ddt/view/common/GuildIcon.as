package ddt.view.common
{
   ...
   public class GuildIcon extends Sprite implements Disposeable, ITipedDisplay
   {
      ...
      public function setInfo(param1:int, param2:int, param3:int) : void
      {
         ...
         this._level = param1;
         this._repute = param3;
         var _loc4_:int = PlayerManager.Instance.Self.ConsortiaID > 0 ? (param2 == PlayerManager.Instance.Self.ConsortiaID ? GuildIconTipInfo.MEMBER : GuildIconTipInfo.ENEMY) : GuildIconTipInfo.NEUTRAL;
         this._icon.setFrame(_loc4_ == GuildIconTipInfo.ENEMY ? 2 : 1);
      ...
      {
         var _loc1_:int = PlayerManager.Instance.Self.ConsortiaID > 0 ? (this._cid == PlayerManager.Instance.Self.ConsortiaID ? GuildIconTipInfo.MEMBER : GuildIconTipInfo.ENEMY) : GuildIconTipInfo.NEUTRAL;
         this._icon.setFrame(_loc1_ == GuildIconTipInfo.ENEMY ? 2 : 1);
