package ddt.view.buff.buffButton
{
   ...
   public class BuffButton extends Sprite implements Disposeable, ITipedDisplay
   {
      ...
      {
         SocketManager.Instance.out.sendUseCard(-1,-1,[ShopManager.Instance.getMoneyShopItemByTemplateID(this._info.buffItemInfo.TemplateID).GoodsID],1,false,param1);
      }
      ...
      protected function __onBuyResponse(param1:FrameEvent) : void
      {
         ...
         {
            _loc3_ = ShopManager.Instance.getMoneyShopItemByTemplateID(this._info.buffItemInfo.TemplateID).getItemPrice(1).moneyValue;
            if(BuriedManager.Instance.checkMoney(_loc2_,_loc3_))
            {
               return;
            }
            this.buyBuff(_loc2_);
