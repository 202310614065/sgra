package ddt.view.chat
{
   ...
   public class ChatOutputView extends Sprite
   {
      ...
      private function initBtns() : void
      {
         ...
         this._privateBtnEffect = EffectManager.Instance.creatEffect(EffectTypes.ADD_MOVIE_EFFECT,this._privateBtn,"chat.ChatPrivateShineEffect",_loc1_,_loc2_);
      ...
      private function updateOutputViewState() : void
      {
         ...
         else if(ChatManager.Instance.state == ChatManager.CHAT_TREASURE_STATE)
         {
            this.bg = 7;
      ...
      public function updateCurrnetChannel() : void
      {
         ...
         {
            _loc1_ = this._model.getChatsByOutputChannel(this._channel,this._currentOffset,this._more.selected ? 16 : 6);
