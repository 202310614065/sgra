package ddt.view.chat.chatBall
{
   ...
   public class ChatBallTextAreaBoss extends ChatBallTextAreaNPC
   {
      ...
      override protected function setFormat() : void
      {
         ...
         _loc1_.parseCSS("p{font-size:12px;text-align:left;font-weight:bold;leading:3px;}" + ".red{color:#FF0000;}" + ".blue{color:#0000FF;}" + ".green{color:#00FF00;}");
      ...
      private function redrawMask(param1:int) : void
      {
         ...
         if(_loc2_)
         {
            ...
            this._maskMC.graphics.drawRect(_loc4_.x,_loc4_.y,_loc4_.width,_loc4_.height + 3);
         ...
         this._maskMC.graphics.lineTo(0,_loc4_.y + _loc4_.height + 3);
         this._maskMC.graphics.lineTo(_loc4_.x + _loc4_.width,_loc4_.y + _loc4_.height + 3);
         this._maskMC.graphics.lineTo(_loc4_.x + _loc4_.width,_loc4_.y - 4);
         this._maskMC.graphics.lineTo(tf.width,_loc4_.y - 4);
