package ddt.view.chat
{
   ...
   public class ChatScrollBar extends Sprite implements Disposeable
   {
      ...
      private function drawThumb(param1:Number) : void
      {
         ...
         var _loc3_:BitmapData = new BitmapData(12,4);
         var _loc4_:BitmapData = new BitmapData(12,4);
         var _loc5_:BitmapData = new BitmapData(12,4);
         _loc3_.copyPixels(this._bitDB,new Rectangle(0,0,12,4),new Point(0,0));
         _loc4_.copyPixels(this._bitDB,new Rectangle(0,4,12,4),new Point(0,0));
         _loc5_.copyPixels(this._bitDB,new Rectangle(0,this._bitDB.height - 4,12,4),new Point(0,0));
         this._moveBtn.graphics.clear();
         ...
         this._moveBtn.graphics.drawRect(0,4,12,param1 - 4);
         _loc2_.ty = param1 - 4;
         this._moveBtn.graphics.beginBitmapFill(_loc5_,_loc2_,false);
         this._moveBtn.graphics.drawRect(0,param1 - 4,12,4);
      ...
      public function set currentIndex(param1:int) : void
      {
         ...
         {
            this._currentIndex = param1 + this._rowsOfScreen > this._length ? this._length - this._rowsOfScreen : param1;
            this.draw();
         }
      }
