   ...
   public class ChatInputField extends Sprite
   {
         ...
         if(_loc3_.indexOf("/") == 0)
         {
            ...
            while(_loc6_ < this.CHANNEL_KEY_SET.length)
            {
               if(_loc3_.indexOf("/" + this.CHANNEL_KEY_SET[_loc6_]) == 0)
               {
                  ...
                  dispatchEvent(new ChatEvent(ChatEvent.INPUT_CHANNEL_CHANNGED,this.CHANNEL_SET[_loc6_]));
               }
               _loc6_++;
            }
            if(!_loc4_)
      ...
      public function setPrivateChatName(param1:String, param2:int = 0, param3:Object = null) : void
      {
         ...
         if(this._privateChatName != "")
         {
            ...
            {
               this._nameTextField.htmlText = LanguageMgr.GetTranslation("tank.view.chat.ChatInput.usernameField.textII",this._privateChatInfo.areaName,_loc4_);
            }
         }
         else
         {
