package ddt.view
{
   ...
   public class DailyButtunBar extends Sprite implements Disposeable
   {
      ...
      private var _savePageBtn:SimpleBitmapButton;
      ...
      public function dispose() : void
      {
         ...
         ObjectUtils.disposeObject(this._savePageBtn);
         this._savePageBtn = null;
      ...
      public function initView() : void
      {
         ...
         this._savePageBtn = ComponentFactory.Instance.creatComponentByStylename("core.hall.savePageBtn");
         this._savePageBtn.tipData = LanguageMgr.GetTranslation("tank.view.common.BellowStripViewII.savePage");
         addChild(this._savePageBtn);
         this._savePageBtn.addEventListener(MouseEvent.CLICK,this.__onSavePageClick);
      ...
      private function __onSavePageClick(param1:MouseEvent) : void
      {
         SoundManager.instance.play("015");
         navigateToURL(new URLRequest("CreatShortCut.ashx?gameurl=" + PathManager.savePageLink()),"_blank");
      }
      ...
      {
         if(param1.module == UIModuleTypes.DDT_FEEDBACK)
         {
