   ...
   public class AcademyIconTip extends Sprite implements Disposeable, ITip
   {
      ...
      private function update() : void
      {
         ...
         if(this._tipData.apprenticeshipState == AcademyManager.MASTER_STATE || this._tipData.apprenticeshipState == AcademyManager.MASTER_FULL_STATE)
         {
            ...
            {
               if(Boolean(this._tipData.getMasterOrApprentices().list[_loc2_]) && this._tipData.getMasterOrApprentices().list[_loc2_] != "")
               {
                  ...
                  this._textFrameArray[_loc2_].setTextFormat(this._contentLabel,this._textFrameArray[_loc2_].text.indexOf(this._tipData.getMasterOrApprentices().list[_loc2_]),this._textFrameArray[_loc2_].text.indexOf(this._tipData.getMasterOrApprentices().list[_loc2_]) + this._tipData.getMasterOrApprentices().list[_loc2_].length);
