   ...
   public class RecommendPlayerCellView extends Sprite implements Disposeable, ITipedDisplay
   {
      ...
      protected function checkVip(param1:PlayerInfo) : void
      {
         if(param1.IsVIP)
         {
            ...
            this._vipName = VipController.instance.getVipNameTxt(142,param1.typeVIP);
         ...
         PositionUtils.adaptNameStyle(param1,this._nameTxt,this._vipName);
      }
