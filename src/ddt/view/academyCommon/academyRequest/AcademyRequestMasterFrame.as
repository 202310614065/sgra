package ddt.view.academyCommon.academyRequest
{
   ...
   public class AcademyRequestMasterFrame extends BaseAlerFrame implements Disposeable
   {
      ...
      protected function initContent() : void
      {
         ...
         this._alertInfo.customPos = ComponentFactory.Instance.creatCustomObject("academyCommon.myAcademy.requireSmallPos");
         ...
         this._inputBG2 = ComponentFactory.Instance.creatComponentByStylename("academyCommon.academyRequest.inputBg2");
         addToContent(this._inputBG2);
         ...
         this._explainText = ComponentFactory.Instance.creat("academyCommon.academyRequestMasterFrame.explainText");
